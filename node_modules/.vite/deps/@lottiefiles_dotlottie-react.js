...
function i(e7) {
  ...
  return i = typeof Symbol == `function` && typeof Symbol.iterator == `symbol` ? function(e8) {
    return typeof e8;
  } : function(e8) {
...
function a(e7, t2) {
  if (i(e7) != `object` || !e7) return e7;
  var n2 = e7[Symbol.toPrimitive];
  if (n2 !== void 0) {
    var r2 = n2.call(e7, t2 || `default`);
    if (i(r2) != `object`) return r2;
    throw TypeError(`@@toPrimitive must return a primitive value.`);
  }
  return (t2 === `string` ? String : Number)(e7);
}
function o(e7) {
  var t2 = a(e7, `string`);
...
function s(e7, t2, n2) {
  return (t2 = o(t2)) in e7 ? Object.defineProperty(e7, t2, { value: n2, enumerable: true, configurable: true, writable: true }) : e7[t2] = n2, e7;
}
var c = class {
  requestAnimationFrame(e7) {
    return requestAnimationFrame(e7);
  }
  cancelAnimationFrame(e7) {
    cancelAnimationFrame(e7);
  }
};
var l = class {
...
var u = class {
  ...
  requestAnimationFrame(e7) {
    return this._strategy.requestAnimationFrame(e7);
  }
  cancelAnimationFrame(e7) {
    this._strategy.cancelAnimationFrame(e7);
  }
};
...
var g = (() => {
  var _a;
  var e7 = typeof document < `u` ? (_a = document.currentScript) == null ? void 0 : _a.src : void 0;
  return (function(t2 = {}) {
    var n2;
    ...
    function a2(e8, t3) {
      ...
      var n3 = e8[Symbol.toPrimitive];
      if (n3 !== void 0) {
        var r3 = n3.call(e8, t3 || `default`);
        if (typeof r3 != `object`) return r3;
        throw TypeError(`@@toPrimitive must return a primitive value.`);
      }
      return (t3 === `string` ? String : Number)(e8);
    }
    var o2 = t2, s2, c2, l2 = new Promise((e8, t3) => {
      s2 = e8, c2 = t3;
    }), u2 = Object.assign({}, o2), d2 = `./this.program`, f2 = ``, p2;
    typeof document < `u` && document.currentScript && (f2 = document.currentScript.src), e7 && (f2 = e7), f2 = f2.startsWith(`blob:`) ? `` : f2.substr(0, f2.replace(/[?#].*/, ``).lastIndexOf(`/`) + 1), p2 = async (e8) => {
      if (e8 = await fetch(e8, { credentials: `same-origin` }), e8.ok) return e8.arrayBuffer();
      throw Error(e8.status + ` : ` + e8.url);
    };
    var m2 = o2.printErr || console.error.bind(console);
    Object.assign(o2, u2), u2 = null, o2.thisProgram && (d2 = o2.thisProgram);
    var h2 = o2.wasmBinary, g2, _2 = false, v2, y2, b2, x2, S2, C2, w2, ee2, T2;
    function E2() {
      var e8 = g2.buffer;
      o2.HEAP8 = y2 = new Int8Array(e8), o2.HEAP16 = x2 = new Int16Array(e8), o2.HEAPU8 = b2 = new Uint8Array(e8), o2.HEAPU16 = S2 = new Uint16Array(e8), o2.HEAP32 = C2 = new Int32Array(e8), o2.HEAPU32 = w2 = new Uint32Array(e8), o2.HEAPF32 = ee2 = new Float32Array(e8), o2.HEAPF64 = T2 = new Float64Array(e8);
    }
    var D2 = [], O2 = [], k2 = [];
    function A2() {
      var e8 = o2.preRun.shift();
      D2.unshift(e8);
    }
    var j2 = 0, M2 = null;
    function N2(e8) {
      var t3;
      throw (t3 = o2.onAbort) == null || t3.call(o2, e8), e8 = `Aborted(` + e8 + `)`, m2(e8), _2 = true, e8 = new WebAssembly.RuntimeError(e8 + `. Build with -sASSERTIONS for more info.`), c2(e8), e8;
    }
    var P2 = (e8) => e8.startsWith(`data:application/octet-stream;base64,`), F2;
    async function te2(e8) {
      if (!h2) try {
        var t3 = await p2(e8);
        return new Uint8Array(t3);
      } catch {
      }
      if (e8 == F2 && h2) e8 = new Uint8Array(h2);
      else throw `both async and sync fetching of the wasm failed`;
      return e8;
    }
    async function ne2(e8, t3) {
      try {
        var n3 = await te2(e8);
        return await WebAssembly.instantiate(n3, t3);
      } catch (e9) {
        m2(`failed to asynchronously prepare wasm: ${e9}`), N2(e9);
      }
    }
    async function re2(e8) {
      var t3 = F2;
      if (!h2 && typeof WebAssembly.instantiateStreaming == `function` && !P2(t3) && typeof fetch == `function`) try {
        var n3 = fetch(t3, { credentials: `same-origin` });
        return await WebAssembly.instantiateStreaming(n3, e8);
      } catch (e9) {
        m2(`wasm streaming compile failed: ${e9}`), m2(`falling back to ArrayBuffer instantiation`);
      }
      return ne2(t3, e8);
    }
    class ie2 {
      constructor(e8) {
        r2(this, `name`, `ExitStatus`), this.message = `Program terminated with exit(${e8})`, this.status = e8;
      }
    }
    var I2 = (e8) => {
      for (; 0 < e8.length; ) e8.shift()(o2);
    }, L2 = o2.noExitRuntime || true, ae2 = typeof TextDecoder < `u` ? new TextDecoder() : void 0, R2 = function() {
      let e8 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : NaN;
      var n3 = b2, r3 = e8 + t3;
      for (t3 = e8; n3[t3] && !(t3 >= r3); ) ++t3;
      if (16 < t3 - e8 && n3.buffer && ae2) return ae2.decode(n3.subarray(e8, t3));
      for (r3 = ``; e8 < t3; ) {
        var i3 = n3[e8++];
        if (i3 & 128) {
          var a3 = n3[e8++] & 63;
          if ((i3 & 224) == 192) r3 += String.fromCharCode((i3 & 31) << 6 | a3);
          else {
            var o3 = n3[e8++] & 63;
            i3 = (i3 & 240) == 224 ? (i3 & 15) << 12 | a3 << 6 | o3 : (i3 & 7) << 18 | a3 << 12 | o3 << 6 | n3[e8++] & 63, 65536 > i3 ? r3 += String.fromCharCode(i3) : (i3 -= 65536, r3 += String.fromCharCode(55296 | i3 >> 10, 56320 | i3 & 1023));
          }
    ...
    var se2 = 0, ce2 = 0, le = (e8, t3, n3) => {
      var r3 = b2;
      if (0 < n3) {
        n3 = t3 + n3 - 1;
        for (var i3 = 0; i3 < e8.length; ++i3) {
          var a3 = e8.charCodeAt(i3);
          if (55296 <= a3 && 57343 >= a3) {
            var o3 = e8.charCodeAt(++i3);
            a3 = 65536 + ((a3 & 1023) << 10) | o3 & 1023;
          }
          if (127 >= a3) {
            if (t3 >= n3) break;
            r3[t3++] = a3;
            ...
            if (2047 >= a3) {
              ...
              if (65535 >= a3) {
                ...
                if (t3 + 3 >= n3) break;
                r3[t3++] = 240 | a3 >> 18, r3[t3++] = 128 | a3 >> 12 & 63;
              }
              r3[t3++] = 128 | a3 >> 6 & 63;
            }
            r3[t3++] = 128 | a3 & 63;
    ...
    function fe(e8) {
      return this.fromWireType(w2[e8 >> 2]);
    }
    var z = {}, B = {}, pe = {}, me, V = (e8, t3, n3) => {
      function r3(t4) {
        if (t4 = n3(t4), t4.length !== e8.length) throw new me(`Mismatched type converter count`);
        for (var r4 = 0; r4 < e8.length; ++r4) W(e8[r4], t4[r4]);
      }
      e8.forEach((e9) => pe[e9] = t3);
      var i3 = Array(t3.length), a3 = [], o3 = 0;
      t3.forEach((e9, t4) => {
        B.hasOwnProperty(e9) ? i3[t4] = B[e9] : (a3.push(e9), z.hasOwnProperty(e9) || (z[e9] = []), z[e9].push(() => {
          i3[t4] = B[e9], ++o3, o3 === a3.length && r3(i3);
        }));
      }), a3.length === 0 && r3(i3);
    }, he, H = (e8) => {
      for (var t3 = ``; b2[e8]; ) t3 += he[b2[e8++]];
      return t3;
    }, U;
    function ge(e8, t3) {
      let n3 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      var r3 = t3.name;
      if (!e8) throw new U(`type "${r3}" must have a positive integer typeid pointer`);
      if (B.hasOwnProperty(e8)) {
        if (n3.hb) return;
        throw new U(`Cannot register type '${r3}' twice`);
      }
      B[e8] = t3, delete pe[e8], z.hasOwnProperty(e8) && (t3 = z[e8], delete z[e8], t3.forEach((e9) => e9()));
    }
    function W(e8, t3) {
      return ge(e8, t3, arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {});
    }
    var _e = (e8) => {
      throw new U(e8.Aa.Da.Ba.name + ` instance already deleted`);
    }, ve = false, ye = () => {
    }, be = (e8, t3, n3) => t3 === n3 ? e8 : n3.Ga === void 0 ? null : (e8 = be(e8, t3, n3.Ga), e8 === null ? null : n3.$a(e8)), xe = {}, Se = {}, Ce = (e8, t3) => {
      if (t3 === void 0) throw new U(`ptr should not be undefined`);
      for (; e8.Ga; ) t3 = e8.Qa(t3), e8 = e8.Ga;
      return Se[t3];
    }, we = (e8, t3) => {
      if (!t3.Da || !t3.Ca) throw new me(`makeClassHandle requires ptr and ptrType`);
      if (!!t3.Ha != !!t3.Fa) throw new me(`Both smartPtrType and smartPtr must be specified`);
      return t3.count = { value: 1 }, Te(Object.create(e8, { Aa: { value: t3, writable: true } }));
    }, Te = (e8) => typeof FinalizationRegistry > `u` ? (Te = (e9) => e9, e8) : (ve = new FinalizationRegistry((e9) => {
      e9 = e9.Aa, --e9.count.value, e9.count.value === 0 && (e9.Fa ? e9.Ha.Ka(e9.Fa) : e9.Da.Ba.Ka(e9.Ca));
    }), Te = (e9) => {
      var t3 = e9.Aa;
      return t3.Fa && ve.register(e9, { Aa: t3 }, e9), e9;
    }, ye = (e9) => {
      ve.unregister(e9);
    }, Te(e8)), Ee = [];
    function De() {
    }
    var Oe = (e8, t3) => Object.defineProperty(t3, `name`, { value: e8 }), ke = (e8, t3, n3) => {
      if (e8[t3].Ea === void 0) {
        var r3 = e8[t3];
        e8[t3] = function() {
          var r4 = [...arguments];
          if (!e8[t3].Ea.hasOwnProperty(r4.length)) throw new U(`Function '${n3}' called with an invalid number of arguments (${r4.length}) - expects one of (${e8[t3].Ea})!`);
          return e8[t3].Ea[r4.length].apply(this, r4);
        }, e8[t3].Ea = [], e8[t3].Ea[r3.Na] = r3;
      }
    }, Ae = (e8, t3, n3) => {
      if (o2.hasOwnProperty(e8)) {
        if (n3 === void 0 || o2[e8].Ea !== void 0 && o2[e8].Ea[n3] !== void 0) throw new U(`Cannot register public name '${e8}' twice`);
        if (ke(o2, e8, e8), o2[e8].Ea.hasOwnProperty(n3)) throw new U(`Cannot register multiple overloads of a function with the same number of arguments (${n3})!`);
        o2[e8].Ea[n3] = t3;
      } else o2[e8] = t3, o2[e8].Na = n3;
    }, je = (e8) => {
      e8 = e8.replace(/[^a-zA-Z0-9_]/g, `$`);
      var t3 = e8.charCodeAt(0);
      return 48 <= t3 && 57 >= t3 ? `_${e8}` : e8;
    };
    function Me(e8, t3, n3, r3, i3, a3, o3, s3) {
      this.name = e8, this.constructor = t3, this.Ma = n3, this.Ka = r3, this.Ga = i3, this.bb = a3, this.Qa = o3, this.$a = s3, this.jb = [];
    }
    var Ne = (e8, t3, n3) => {
      for (; t3 !== n3; ) {
        if (!t3.Qa) throw new U(`Expected null or instance of ${n3.name}, got an instance of ${t3.name}`);
        e8 = t3.Qa(e8), t3 = t3.Ga;
      }
      return e8;
    };
    function Pe(e8, t3) {
      ...
      if (!t3.Aa) throw new U(`Cannot pass "${et(t3)}" as a ${this.name}`);
      if (!t3.Aa.Ca) throw new U(`Cannot pass deleted object as a pointer of type ${this.name}`);
      return Ne(t3.Aa.Ca, t3.Aa.Da.Ba, this.Ba);
    }
    function Fe(e8, t3) {
      if (t3 === null) {
        if (this.Ta) throw new U(`null is not a valid ${this.name}`);
        if (this.Sa) {
          var n3 = this.Ua();
          return e8 !== null && e8.push(this.Ka, n3), n3;
        }
        return 0;
      }
      if (!t3 || !t3.Aa) throw new U(`Cannot pass "${et(t3)}" as a ${this.name}`);
      if (!t3.Aa.Ca) throw new U(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.Ra && t3.Aa.Da.Ra) throw new U(`Cannot convert argument of type ${t3.Aa.Ha ? t3.Aa.Ha.name : t3.Aa.Da.name} to parameter type ${this.name}`);
      if (n3 = Ne(t3.Aa.Ca, t3.Aa.Da.Ba, this.Ba), this.Sa) {
        if (t3.Aa.Fa === void 0) throw new U(`Passing raw pointer to smart pointer is illegal`);
        switch (this.ob) {
          case 0:
            if (t3.Aa.Ha === this) n3 = t3.Aa.Fa;
            else throw new U(`Cannot convert argument of type ${t3.Aa.Ha ? t3.Aa.Ha.name : t3.Aa.Da.name} to parameter type ${this.name}`);
            break;
          case 1:
            n3 = t3.Aa.Fa;
            break;
          case 2:
            if (t3.Aa.Ha === this) n3 = t3.Aa.Fa;
              ...
              var r3 = t3.clone();
              n3 = this.kb(n3, Xe(() => r3.delete())), e8 !== null && e8.push(this.Ka, n3);
            }
            break;
          default:
    ...
    function Ie(e8, t3) {
      ...
      if (!t3.Aa) throw new U(`Cannot pass "${et(t3)}" as a ${this.name}`);
      if (!t3.Aa.Ca) throw new U(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (t3.Aa.Da.Ra) throw new U(`Cannot convert argument of type ${t3.Aa.Da.name} to parameter type ${this.name}`);
      return Ne(t3.Aa.Ca, t3.Aa.Da.Ba, this.Ba);
    }
    function Le(e8, t3, n3, r3, i3, a3, o3, s3, c3, l3, u3) {
      this.name = e8, this.Ba = t3, this.Ta = n3, this.Ra = r3, this.Sa = i3, this.ib = a3, this.ob = o3, this.Ya = s3, this.Ua = c3, this.kb = l3, this.Ka = u3, i3 || t3.Ga !== void 0 ? this.toWireType = Fe : (this.toWireType = r3 ? Pe : Ie, this.Ja = null);
    }
    var Re = (e8, t3, n3) => {
      if (!o2.hasOwnProperty(e8)) throw new me(`Replacing nonexistent public symbol`);
      o2[e8].Ea !== void 0 && n3 !== void 0 ? o2[e8].Ea[n3] = t3 : (o2[e8] = t3, o2[e8].Na = n3);
    }, G, ze = function(e8, t3) {
      let n3 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      return e8.includes(`j`) ? (e8 = e8.replace(/p/g, `i`), t3 = (0, o2[`dynCall_` + e8])(t3, ...n3)) : t3 = G.get(t3)(...n3), t3;
    }, Be = (e8, t3) => function() {
      return ze(e8, t3, [...arguments]);
    }, K = (e8, t3) => {
      e8 = H(e8);
      var n3 = e8.includes(`j`) ? Be(e8, t3) : G.get(t3);
      if (typeof n3 != `function`) throw new U(`unknown function pointer with signature ${e8}: ${t3}`);
      return n3;
    }, Ve, He = (e8) => {
      e8 = At(e8);
      var t3 = H(e8);
      ...
      function n3(e9) {
        i3[e9] || B[e9] || (pe[e9] ? pe[e9].forEach(n3) : (r3.push(e9), i3[e9] = true));
      }
      var r3 = [], i3 = {};
      throw t3.forEach(n3), new Ve(`${e8}: ` + r3.map(He).join([`, `]));
    }, We = (e8, t3) => {
      for (var n3 = [], r3 = 0; r3 < e8; r3++) n3.push(w2[t3 + 4 * r3 >> 2]);
      return n3;
    };
    function Ge(e8) {
      for (var t3 = 1; t3 < e8.length; ++t3) if (e8[t3] !== null && e8[t3].Ja === void 0) return true;
      return false;
    }
    function Ke(e8, t3, n3, r3, i3) {
      var a3 = t3.length;
      if (2 > a3) throw new U(`argTypes array size mismatch! Must at least get return value and 'this' types!`);
      var o3 = t3[1] !== null && n3 !== null, s3 = Ge(t3), c3 = t3[0].name !== `void`, l3 = a3 - 2, u3 = Array(l3), d3 = [], f3 = [];
      return Oe(e8, function() {
        var e9 = [...arguments];
        if (f3.length = 0, d3.length = o3 ? 2 : 1, d3[0] = i3, o3) {
          var n4 = t3[1].toWireType(f3, this);
          d3[1] = n4;
        }
        for (var a4 = 0; a4 < l3; ++a4) u3[a4] = t3[a4 + 2].toWireType(f3, e9[a4]), d3.push(u3[a4]);
        if (e9 = r3(...d3), s3) de(f3);
        else for (a4 = o3 ? 1 : 2; a4 < t3.length; a4++) {
          var p3 = a4 === 1 ? n4 : u3[a4 - 2];
          t3[a4].Ja !== null && t3[a4].Ja(p3);
        }
        return n4 = c3 ? t3[0].fromWireType(e9) : void 0, n4;
      });
    }
    var qe = (e8) => {
      e8 = e8.trim();
      let t3 = e8.indexOf(`(`);
      return t3 === -1 ? e8 : e8.substr(0, t3);
    }, Je = [], q = [], Ye = (e8) => {
      9 < e8 && --q[e8 + 1] === 0 && (q[e8] = void 0, Je.push(e8));
    }, J = (e8) => {
      if (!e8) throw new U(`Cannot use deleted val. handle = ` + e8);
      return q[e8];
    }, Xe = (e8) => {
      switch (e8) {
        case void 0:
        ...
        case false:
          return 8;
        default:
          let t3 = Je.pop() || q.length;
          return q[t3] = e8, q[t3 + 1] = 1, t3;
      }
    }, Ze = { name: `emscripten::val`, fromWireType: (e8) => {
      var t3 = J(e8);
      return Ye(e8), t3;
    }, toWireType: (e8, t3) => Xe(t3), Ia: 8, readValueFromPointer: fe, Ja: null }, Qe = (e8, t3, n3) => {
      switch (t3) {
        case 1:
          return n3 ? function(e9) {
            return this.fromWireType(y2[e9]);
          } : function(e9) {
            return this.fromWireType(b2[e9]);
          };
        case 2:
          return n3 ? function(e9) {
            return this.fromWireType(x2[e9 >> 1]);
          } : function(e9) {
            return this.fromWireType(S2[e9 >> 1]);
          };
        case 4:
          return n3 ? function(e9) {
            return this.fromWireType(C2[e9 >> 2]);
          } : function(e9) {
            return this.fromWireType(w2[e9 >> 2]);
          };
        default:
          throw TypeError(`invalid integer width (${t3}): ${e8}`);
      }
    }, $e = (e8, t3) => {
      var n3 = B[e8];
      if (n3 === void 0) throw e8 = `${t3} has unknown type ${He(e8)}`, new U(e8);
      return n3;
    }, et = (e8) => {
      if (e8 === null) return `null`;
      var t3 = typeof e8;
      return t3 === `object` || t3 === `array` || t3 === `function` ? e8.toString() : `` + e8;
    }, tt = (e8, t3) => {
      switch (t3) {
        case 4:
          return function(e9) {
            return this.fromWireType(ee2[e9 >> 2]);
          };
        case 8:
          return function(e9) {
            return this.fromWireType(T2[e9 >> 3]);
          };
        default:
          throw TypeError(`invalid float width (${t3}): ${e8}`);
      }
    }, nt = (e8, t3, n3) => {
      switch (t3) {
        case 1:
          return n3 ? (e9) => y2[e9] : (e9) => b2[e9];
        case 2:
          return n3 ? (e9) => x2[e9 >> 1] : (e9) => S2[e9 >> 1];
        case 4:
          return n3 ? (e9) => C2[e9 >> 2] : (e9) => w2[e9 >> 2];
        default:
          throw TypeError(`invalid integer width (${t3}): ${e8}`);
      }
    }, rt = Object.assign({ optional: true }, Ze), it = typeof TextDecoder < `u` ? new TextDecoder(`utf-16le`) : void 0, at = (e8, t3) => {
      for (var n3 = e8 >> 1, r3 = n3 + t3 / 2; !(n3 >= r3) && S2[n3]; ) ++n3;
      if (n3 <<= 1, 32 < n3 - e8 && it) return it.decode(b2.subarray(e8, n3));
      for (n3 = ``, r3 = 0; !(r3 >= t3 / 2); ++r3) {
        var i3 = x2[e8 + 2 * r3 >> 1];
        if (i3 == 0) break;
        n3 += String.fromCharCode(i3);
      }
      return n3;
    }, ot = (e8, t3, n3) => {
      ...
      n3 -= 2;
      var r3 = t3;
      n3 = n3 < 2 * e8.length ? n3 / 2 : e8.length;
      for (var i3 = 0; i3 < n3; ++i3) x2[t3 >> 1] = e8.charCodeAt(i3), t3 += 2;
      return x2[t3 >> 1] = 0, t3 - r3;
    }, st = (e8) => 2 * e8.length, ct = (e8, t3) => {
      for (var n3 = 0, r3 = ``; !(n3 >= t3 / 4); ) {
        var i3 = C2[e8 + 4 * n3 >> 2];
        if (i3 == 0) break;
        ++n3, 65536 <= i3 ? (i3 -= 65536, r3 += String.fromCharCode(55296 | i3 >> 10, 56320 | i3 & 1023)) : r3 += String.fromCharCode(i3);
      }
      return r3;
    }, lt = (e8, t3, n3) => {
      if (n3 ?? (n3 = 2147483647), 4 > n3) return 0;
      var r3 = t3;
      n3 = r3 + n3 - 4;
      for (var i3 = 0; i3 < e8.length; ++i3) {
        var a3 = e8.charCodeAt(i3);
        ...
        if (C2[t3 >> 2] = a3, t3 += 4, t3 + 4 > n3) break;
      }
      return C2[t3 >> 2] = 0, t3 - r3;
    }, ut = (e8) => {
      for (var t3 = 0, n3 = 0; n3 < e8.length; ++n3) {
        var r3 = e8.charCodeAt(n3);
        55296 <= r3 && 57343 >= r3 && ++n3, t3 += 4;
      }
      return t3;
    }, dt = 0, ft = (e8, t3, n3) => {
      var r3 = [];
      return e8 = e8.toWireType(r3, n3), r3.length && (w2[t3 >> 2] = Xe(r3)), e8;
    }, pt = [], mt = (e8) => {
      var t3 = pt.length;
      return pt.push(e8), t3;
    }, ht = (e8, t3) => {
      for (var n3 = Array(e8), r3 = 0; r3 < e8; ++r3) n3[r3] = $e(w2[t3 + 4 * r3 >> 2], `parameter ` + r3);
      return n3;
    }, gt = Reflect.construct, _t = {}, vt = (e8) => {
      if (!(e8 instanceof ie2 || e8 == `unwind`)) throw e8;
    }, yt = (e8) => {
      var t3;
      throw v2 = e8, L2 || 0 < dt || ((t3 = o2.onExit) != null && t3.call(o2, e8), _2 = true), new ie2(e8);
    }, bt = (e8) => {
      if (!_2) try {
        if (e8(), !(L2 || 0 < dt)) try {
          v2 = e8 = v2, yt(e8);
      ...
      if (!Ct) {
        var e8 = { USER: `web_user`, LOGNAME: `web_user`, PATH: `/`, PWD: `/`, HOME: `/home/web_user`, LANG: (typeof navigator == `object` && navigator.languages && navigator.languages[0] || `C`).replace(`-`, `_`) + `.UTF-8`, _: d2 || `./this.program` }, t3;
        for (t3 in xt) xt[t3] === void 0 ? delete e8[t3] : e8[t3] = xt[t3];
        var n3 = [];
        for (t3 in e8) n3.push(`${t3}=${e8[t3]}`);
        Ct = n3;
      }
      return Ct;
    }, Ct, wt = () => {
      if (typeof crypto == `object` && typeof crypto.getRandomValues == `function`) return (e8) => crypto.getRandomValues(e8);
      N2(`initRandomDevice`);
    }, Tt = (e8) => (Tt = wt())(e8);
    me = o2.InternalError = class extends Error {
      constructor(e8) {
        super(e8), this.name = `InternalError`;
      }
    };
    for (var Et = Array(256), Dt = 0; 256 > Dt; ++Dt) Et[Dt] = String.fromCharCode(Dt);
    he = Et, U = o2.BindingError = class extends Error {
      constructor(e8) {
        super(e8), this.name = `BindingError`;
      }
    }, Object.assign(De.prototype, { isAliasOf: function(e8) {
      if (!(this instanceof De && e8 instanceof De)) return false;
      var t3 = this.Aa.Da.Ba, n3 = this.Aa.Ca;
      e8.Aa = e8.Aa;
      var r3 = e8.Aa.Da.Ba;
      for (e8 = e8.Aa.Ca; t3.Ga; ) n3 = t3.Qa(n3), t3 = t3.Ga;
      for (; r3.Ga; ) e8 = r3.Qa(e8), r3 = r3.Ga;
      return t3 === r3 && n3 === e8;
    }, clone: function() {
      if (this.Aa.Ca || _e(this), this.Aa.Pa) return this.Aa.count.value += 1, this;
      var e8 = Te, t3 = Object, n3 = t3.create, r3 = Object.getPrototypeOf(this), i3 = this.Aa;
      return e8 = e8(n3.call(t3, r3, { Aa: { value: { count: i3.count, Oa: i3.Oa, Pa: i3.Pa, Ca: i3.Ca, Da: i3.Da, Fa: i3.Fa, Ha: i3.Ha } } })), e8.Aa.count.value += 1, e8.Aa.Oa = false, e8;
    }, delete() {
      if (this.Aa.Ca || _e(this), this.Aa.Oa && !this.Aa.Pa) throw new U(`Object already scheduled for deletion`);
      ye(this);
      var e8 = this.Aa;
      --e8.count.value, e8.count.value === 0 && (e8.Fa ? e8.Ha.Ka(e8.Fa) : e8.Da.Ba.Ka(e8.Ca)), this.Aa.Pa || (this.Aa.Fa = void 0, this.Aa.Ca = void 0);
    }, isDeleted: function() {
      return !this.Aa.Ca;
    }, deleteLater: function() {
      if (this.Aa.Ca || _e(this), this.Aa.Oa && !this.Aa.Pa) throw new U(`Object already scheduled for deletion`);
      return Ee.push(this), this.Aa.Oa = true, this;
    } }), Object.assign(Le.prototype, { cb(e8) {
      return this.Ya && (e8 = this.Ya(e8)), e8;
    }, Wa(e8) {
      var t3;
      (t3 = this.Ka) == null || t3.call(this, e8);
    }, Ia: 8, readValueFromPointer: fe, fromWireType: function(e8) {
      function t3() {
        return this.Sa ? we(this.Ba.Ma, { Da: this.ib, Ca: n3, Ha: this, Fa: e8 }) : we(this.Ba.Ma, { Da: this, Ca: e8 });
      }
      var n3 = this.cb(e8);
      if (!n3) return this.Wa(e8), null;
      var r3 = Ce(this.Ba, n3);
      if (r3 !== void 0) return r3.Aa.count.value === 0 ? (r3.Aa.Ca = n3, r3.Aa.Fa = e8, r3.clone()) : (r3 = r3.clone(), this.Wa(e8), r3);
      if (r3 = this.Ba.bb(n3), r3 = xe[r3], !r3) return t3.call(this);
      r3 = this.Ra ? r3.Za : r3.pointerType;
      var i3 = be(n3, this.Ba, r3.Ba);
      return i3 === null ? t3.call(this) : this.Sa ? we(r3.Ba.Ma, { Da: r3, Ca: i3, Ha: this, Fa: e8 }) : we(r3.Ba.Ma, { Da: r3, Ca: i3 });
    } }), Ve = o2.UnboundTypeError = ((e8, t3) => {
      var n3 = Oe(t3, function(e9) {
        this.name = t3, this.message = e9, e9 = Error(e9).stack, e9 !== void 0 && (this.stack = this.toString() + `
` + e9.replace(/^Error(:[^\n]*)?\n/, ``));
      });
      return n3.prototype = Object.create(e8.prototype), n3.prototype.constructor = n3, n3.prototype.toString = function() {
        return this.message === void 0 ? this.name : `${this.name}: ${this.message}`;
      }, n3;
    })(Error, `UnboundTypeError`), q.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), o2.count_emval_handles = () => q.length / 2 - 5 - Je.length;
    var Ot = { c: (e8, t3, n3, r3) => N2(`Assertion failed: ${e8 ? R2(e8) : ``}, at: ` + [t3 ? t3 ? R2(t3) : `` : `unknown filename`, n3, r3 ? r3 ? R2(r3) : `` : `unknown function`]), j: (e8, t3, n3) => {
      var r3 = new oe2(e8);
      throw w2[r3.Ca + 16 >> 2] = 0, w2[r3.Ca + 4 >> 2] = t3, w2[r3.Ca + 8 >> 2] = n3, se2 = e8, ce2++, se2;
    }, P: () => {
    }, M: () => {
    }, N: () => {
    }, R: function() {
      ...
      var t3 = ue[e8];
      delete ue[e8];
      var n3 = t3.Ua, r3 = t3.Ka, i3 = t3.Xa, a3 = i3.map((e9) => e9.gb).concat(i3.map((e9) => e9.mb));
      V([e8], a3, (e9) => {
        var a4 = {};
        return i3.forEach((t4, n4) => {
          var r4 = e9[n4], o3 = t4.eb, s3 = t4.fb, c3 = e9[n4 + i3.length], l3 = t4.lb, u3 = t4.nb;
          a4[t4.ab] = { read: (e10) => r4.fromWireType(o3(s3, e10)), write: (e10, t5) => {
            var n5 = [];
            l3(u3, e10, c3.toWireType(n5, t5)), de(n5);
          } };
        }), [{ name: t3.name, fromWireType: (e10) => {
          var t4 = {}, n4;
          for (n4 in a4) t4[n4] = a4[n4].read(e10);
          return r3(e10), t4;
        }, toWireType: (e10, t4) => {
          for (var i4 in a4) if (!(i4 in t4)) throw TypeError(`Missing field: "${i4}"`);
          var o3 = n3();
          for (i4 in a4) a4[i4].write(o3, t4[i4]);
          return e10 !== null && e10.push(r3, o3), o3;
        }, Ia: 8, readValueFromPointer: fe, Ja: r3 }];
      });
    }, F: () => {
    }, _: (e8, t3, n3, r3) => {
      t3 = H(t3), W(e8, { name: t3, fromWireType: function(e9) {
        return !!e9;
      }, toWireType: function(e9, t4) {
        return t4 ? n3 : r3;
      }, Ia: 8, readValueFromPointer: function(e9) {
        return this.fromWireType(b2[e9]);
      }, Ja: null });
    }, k: (e8, t3, n3, r3, i3, a3, o3, s3, c3, l3, u3, d3, f3) => {
      u3 = H(u3), a3 = K(i3, a3), s3 && (s3 = K(o3, s3)), l3 && (l3 = K(c3, l3)), f3 = K(d3, f3);
      var p3 = je(u3);
      Ae(p3, function() {
        Ue(`Cannot construct ${u3} due to unbound types`, [r3]);
      }), V([e8, t3, n3], r3 ? [r3] : [], (t4) => {
        if (t4 = t4[0], r3) var n4 = t4.Ba, i4 = n4.Ma;
        else i4 = De.prototype;
        t4 = Oe(u3, function() {
          if (Object.getPrototypeOf(this) !== o4) throw new U(`Use 'new' to construct ` + u3);
          if (c4.La === void 0) throw new U(u3 + ` has no accessible constructor`);
          var e9 = [...arguments], t5 = c4.La[e9.length];
          if (t5 === void 0) throw new U(`Tried to invoke ctor of ${u3} with invalid number of parameters (${e9.length}) - expected (${Object.keys(c4.La).toString()}) parameters instead!`);
          return t5.apply(this, e9);
        });
        var o4 = Object.create(i4, { constructor: { value: t4 } });
        t4.prototype = o4;
        var c4 = new Me(u3, t4, o4, f3, n4, a3, s3, l3);
        if (c4.Ga) {
          var d4;
          (d4 = c4.Ga).Va ?? (d4.Va = []), c4.Ga.Va.push(c4);
        }
        return n4 = new Le(u3, c4, true, false, false), d4 = new Le(u3 + `*`, c4, false, false, false), i4 = new Le(u3 + ` const*`, c4, false, true, false), xe[e8] = { pointerType: d4, Za: i4 }, Re(p3, t4), [n4, d4, i4];
      });
    }, r: (e8, t3, n3, r3, i3, a3) => {
      var o3 = We(t3, n3);
      i3 = K(r3, i3), V([], [e8], (e9) => {
        e9 = e9[0];
        var n4 = `constructor ${e9.name}`;
        if (e9.Ba.La === void 0 && (e9.Ba.La = []), e9.Ba.La[t3 - 1] !== void 0) throw new U(`Cannot register multiple constructors with identical number of parameters (${t3 - 1}) for class '${e9.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return e9.Ba.La[t3 - 1] = () => {
          Ue(`Cannot construct ${e9.name} due to unbound types`, o3);
        }, V([], o3, (r4) => (r4.splice(1, 0, null), e9.Ba.La[t3 - 1] = Ke(n4, r4, null, i3, a3), [])), [];
      });
    }, d: (e8, t3, n3, r3, i3, a3, o3, s3) => {
      var c3 = We(n3, r3);
      t3 = H(t3), t3 = qe(t3), a3 = K(i3, a3), V([], [e8], (e9) => {
        function r4() {
          Ue(`Cannot call ${i4} due to unbound types`, c3);
        }
        e9 = e9[0];
        var i4 = `${e9.name}.${t3}`;
        t3.startsWith(`@@`) && (t3 = Symbol[t3.substring(2)]), s3 && e9.Ba.jb.push(t3);
        var l3 = e9.Ba.Ma, u3 = l3[t3];
        return u3 === void 0 || u3.Ea === void 0 && u3.className !== e9.name && u3.Na === n3 - 2 ? (r4.Na = n3 - 2, r4.className = e9.name, l3[t3] = r4) : (ke(l3, t3, i4), l3[t3].Ea[n3 - 2] = r4), V([], c3, (r5) => (r5 = Ke(i4, r5, e9, a3, o3), l3[t3].Ea === void 0 ? (r5.Na = n3 - 2, l3[t3] = r5) : l3[t3].Ea[n3 - 2] = r5, [])), [];
      });
    }, Y: (e8) => W(e8, Ze), D: (e8, t3, n3, r3) => {
      function i3() {
      }
      t3 = H(t3), i3.values = {}, W(e8, { name: t3, constructor: i3, fromWireType: function(e9) {
        return this.constructor.values[e9];
      }, toWireType: (e9, t4) => t4.value, Ia: 8, readValueFromPointer: Qe(t3, n3, r3), Ja: null }), Ae(t3, i3);
    }, m: (e8, t3, n3) => {
      var r3 = $e(e8, `enum`);
      t3 = H(t3), e8 = r3.constructor, r3 = Object.create(r3.constructor.prototype, { value: { value: n3 }, constructor: { value: Oe(`${r3.name}_${t3}`, function() {
      }) } }), e8.values[n3] = r3, e8[t3] = r3;
    }, A: (e8, t3, n3) => {
      t3 = H(t3), W(e8, { name: t3, fromWireType: (e9) => e9, toWireType: (e9, t4) => t4, Ia: 8, readValueFromPointer: tt(t3, n3), Ja: null });
    }, u: (e8, t3, n3, r3, i3, a3) => {
      var o3 = We(t3, n3);
      e8 = H(e8), e8 = qe(e8), i3 = K(r3, i3), Ae(e8, function() {
        Ue(`Cannot call ${e8} due to unbound types`, o3);
      }, t3 - 1), V([], o3, (n4) => (Re(e8, Ke(e8, [n4[0], null].concat(n4.slice(1)), null, i3, a3), t3 - 1), []));
    }, n: (e8, t3, n3, r3, i3) => {
      if (t3 = H(t3), i3 === -1 && (i3 = 4294967295), i3 = (e9) => e9, r3 === 0) {
        var a3 = 32 - 8 * n3;
        i3 = (e9) => e9 << a3 >>> a3;
      }
      var o3 = t3.includes(`unsigned`) ? function(e9, t4) {
        return t4 >>> 0;
      } : function(e9, t4) {
        return t4;
      };
      W(e8, { name: t3, fromWireType: i3, toWireType: o3, Ia: 8, readValueFromPointer: nt(t3, n3, r3 !== 0), Ja: null });
    }, g: (e8, t3, n3) => {
      function r3(e9) {
        return new i3(y2.buffer, w2[e9 + 4 >> 2], w2[e9 >> 2]);
      }
      var i3 = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][t3];
      n3 = H(n3), W(e8, { name: n3, fromWireType: r3, Ia: 8, readValueFromPointer: r3 }, { hb: true });
    }, o: (e8) => {
      W(e8, rt);
    }, v: (e8, t3, n3, r3, i3, a3, o3, s3, c3, l3, u3, d3) => {
      n3 = H(n3), a3 = K(i3, a3), s3 = K(o3, s3), l3 = K(c3, l3), d3 = K(u3, d3), V([e8], [t3], (e9) => (e9 = e9[0], [new Le(n3, e9.Ba, false, false, true, e9, r3, a3, s3, l3, d3)]));
    }, Z: (e8, t3) => {
      t3 = H(t3), W(e8, { name: t3, fromWireType: function(e9) {
        for (var t4 = w2[e9 >> 2], n3 = e9 + 4, r3, i3 = n3, a3 = 0; a3 <= t4; ++a3) {
          var o3 = n3 + a3;
          (a3 == t4 || b2[o3] == 0) && (i3 = i3 ? R2(i3, o3 - i3) : ``, r3 === void 0 ? r3 = i3 : (r3 += `\0`, r3 += i3), i3 = o3 + 1);
        }
        return X(e9), r3;
      }, toWireType: function(e9, t4) {
        t4 instanceof ArrayBuffer && (t4 = new Uint8Array(t4));
        var n3, r3 = typeof t4 == `string`;
        if (!(r3 || t4 instanceof Uint8Array || t4 instanceof Uint8ClampedArray || t4 instanceof Int8Array)) throw new U(`Cannot pass non-string to std::string`);
        if (r3) for (var i3 = n3 = 0; i3 < t4.length; ++i3) {
          var a3 = t4.charCodeAt(i3);
          127 >= a3 ? n3++ : 2047 >= a3 ? n3 += 2 : 55296 <= a3 && 57343 >= a3 ? (n3 += 4, ++i3) : n3 += 3;
        }
        else n3 = t4.length;
        if (i3 = kt(4 + n3 + 1), a3 = i3 + 4, w2[i3 >> 2] = n3, r3) le(t4, a3, n3 + 1);
        else if (r3) for (r3 = 0; r3 < n3; ++r3) {
          var o3 = t4.charCodeAt(r3);
          if (255 < o3) throw X(a3), new U(`String has UTF-16 code units that do not fit in 8 bits`);
          b2[a3 + r3] = o3;
        }
        else for (r3 = 0; r3 < n3; ++r3) b2[a3 + r3] = t4[r3];
        return e9 !== null && e9.push(X, i3), i3;
      }, Ia: 8, readValueFromPointer: fe, Ja(e9) {
        X(e9);
      } });
    }, y: (e8, t3, n3) => {
      if (n3 = H(n3), t3 === 2) var r3 = at, i3 = ot, a3 = st, o3 = (e9) => S2[e9 >> 1];
      else t3 === 4 && (r3 = ct, i3 = lt, a3 = ut, o3 = (e9) => w2[e9 >> 2]);
      W(e8, { name: n3, fromWireType: (e9) => {
        for (var n4 = w2[e9 >> 2], i4, a4 = e9 + 4, s3 = 0; s3 <= n4; ++s3) {
          var c3 = e9 + 4 + s3 * t3;
          (s3 == n4 || o3(c3) == 0) && (a4 = r3(a4, c3 - a4), i4 === void 0 ? i4 = a4 : (i4 += `\0`, i4 += a4), a4 = c3 + t3);
        }
        return X(e9), i4;
      }, toWireType: (e9, r4) => {
        if (typeof r4 != `string`) throw new U(`Cannot pass non-string to C++ string type ${n3}`);
        var o4 = a3(r4), s3 = kt(4 + o4 + t3);
        return w2[s3 >> 2] = o4 / t3, i3(r4, s3 + 4, o4 + t3), e9 !== null && e9.push(X, s3), s3;
      }, Ia: 8, readValueFromPointer: fe, Ja(e9) {
        X(e9);
      } });
    }, x: (e8, t3, n3, r3, i3, a3) => {
      ue[e8] = { name: H(t3), Ua: K(n3, r3), Ka: K(i3, a3), Xa: [] };
    }, i: (e8, t3, n3, r3, i3, a3, o3, s3, c3, l3) => {
      ue[e8].Xa.push({ ab: H(t3), gb: n3, eb: K(r3, i3), fb: a3, mb: o3, lb: K(s3, c3), nb: l3 });
    }, $: (e8, t3) => {
      t3 = H(t3), W(e8, { pb: true, name: t3, Ia: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, K: () => {
      L2 = false, dt = 0;
      ...
      throw 1 / 0;
    }, C: (e8, t3, n3) => (e8 = J(e8), t3 = $e(t3, `emval::as`), ft(t3, n3, e8)), q: (e8, t3, n3, r3) => (e8 = pt[e8], t3 = J(t3), e8(null, t3, n3, r3)), W: Ye, E: (e8, t3) => (e8 = J(e8), t3 = J(t3), e8 == t3), p: (e8, t3, n3) => {
      var r3 = ht(e8, t3), i3 = r3.shift();
      e8--;
      var a3 = Array(e8);
      return t3 = `methodCaller<(${r3.map((e9) => e9.name).join(`, `)}) => ${i3.name}>`, mt(Oe(t3, (t4, o3, s3, c3) => {
        for (var l3 = 0, u3 = 0; u3 < e8; ++u3) a3[u3] = r3[u3].readValueFromPointer(c3 + l3), l3 += r3[u3].Ia;
        return t4 = n3 === 1 ? gt(o3, a3) : o3.apply(t4, a3), ft(i3, s3, t4);
      }));
    }, z: (e8) => {
      9 < e8 && (q[e8 + 1] += 1);
    }, ca: (e8) => {
      de(J(e8)), Ye(e8);
    }, s: (e8, t3) => (e8 = $e(e8, `_emval_take_value`), e8 = e8.readValueFromPointer(t3), Xe(e8)), G: (e8, t3) => (_t[e8] && (clearTimeout(_t[e8].id), delete _t[e8]), t3 && (_t[e8] = { id: setTimeout(() => {
      delete _t[e8], bt(() => jt(e8, performance.now()));
    }, t3), qb: t3 }), 0), H: (e8, t3, n3, r3) => {
      var i3 = (/* @__PURE__ */ new Date()).getFullYear(), a3 = new Date(i3, 0, 1).getTimezoneOffset();
      i3 = new Date(i3, 6, 1).getTimezoneOffset(), w2[e8 >> 2] = 60 * Math.max(a3, i3), C2[t3 >> 2] = Number(a3 != i3), t3 = (e9) => {
        var t4 = Math.abs(e9);
        return `UTC${0 <= e9 ? `-` : `+`}${String(Math.floor(t4 / 60)).padStart(2, `0`)}${String(t4 % 60).padStart(2, `0`)}`;
      }, e8 = t3(a3), t3 = t3(i3), i3 < a3 ? (le(e8, n3, 17), le(t3, r3, 17)) : (le(e8, r3, 17), le(t3, n3, 17));
    }, ba: () => performance.now(), J: (e8) => {
      var t3 = b2.length;
      if (e8 >>>= 0, 2147483648 < e8) return false;
      for (var n3 = 1; 4 >= n3; n3 *= 2) {
        var r3 = t3 * (1 + 0.2 / n3);
        r3 = Math.min(r3, e8 + 100663296);
        a: {
          r3 = (Math.min(2147483648, 65536 * Math.ceil(Math.max(e8, r3) / 65536)) - g2.buffer.byteLength + 65535) / 65536 | 0;
          try {
            g2.grow(r3), E2();
            var i3 = 1;
            break a;
      ...
      var n3 = 0;
      return St().forEach((r3, i3) => {
        var a3 = t3 + n3;
        for (i3 = w2[e8 + 4 * i3 >> 2] = a3, a3 = 0; a3 < r3.length; ++a3) y2[i3++] = r3.charCodeAt(a3);
        y2[i3] = 0, n3 += r3.length + 1;
      }), 0;
    }, X: (e8, t3) => {
      var n3 = St();
      w2[e8 >> 2] = n3.length;
      var r3 = 0;
      return n3.forEach((e9) => r3 += e9.length + 1), w2[t3 >> 2] = r3, 0;
    }, S: () => 52, Q: () => 52, l: Mt, f: It, e: zt, B: Nt, aa: Rt, a: Pt, b: Lt, h: Ft, t: Bt, U: yt, L: (e8, t3) => (Tt(b2.subarray(e8, e8 + t3)), 0) }, Y;
    (async function(e8, t3) {
      function n3(e9) {
        var t4;
        return Y = e9.exports, g2 = Y.da, E2(), G = Y.ga, O2.unshift(Y.ea), j2--, (t4 = o2.monitorRunDependencies) == null || t4.call(o2, j2), j2 == 0 && M2 && (e9 = M2, M2 = null, e9()), Y;
      }
      j2++, (e8 = o2.monitorRunDependencies) == null || e8.call(o2, j2);
      var r3 = { a: Ot };
      if (o2.instantiateWasm) try {
        return o2.instantiateWasm(r3, n3);
      } catch (e9) {
        m2(`Module.instantiateWasm callback failed with error: ${e9}`), c2(e9);
      }
      (t3 = F2) ?? (F2 = P2(`DotLottiePlayer.wasm`) ? `DotLottiePlayer.wasm` : o2.locateFile ? o2.locateFile(`DotLottiePlayer.wasm`, f2) : f2 + `DotLottiePlayer.wasm`);
      try {
        var i3 = await re2(r3);
        return n3(i3.instance), i3;
      } catch (e9) {
        c2(e9);
      }
    })();
    var kt = (e8) => (kt = Y.fa)(e8), X = (e8) => (X = Y.ha)(e8), At = (e8) => (At = Y.ia)(e8), jt = (e8, t3) => (jt = Y.ja)(e8, t3), Z = (e8, t3) => (Z = Y.ka)(e8, t3), Q = (e8) => (Q = Y.la)(e8), $ = () => ($ = Y.ma)();
    o2.dynCall_jiii = (e8, t3, n3, r3) => (o2.dynCall_jiii = Y.na)(e8, t3, n3, r3), o2.dynCall_jii = (e8, t3, n3) => (o2.dynCall_jii = Y.oa)(e8, t3, n3), o2.dynCall_vjii = (e8, t3, n3, r3, i3) => (o2.dynCall_vjii = Y.pa)(e8, t3, n3, r3, i3), o2.dynCall_vjfii = (e8, t3, n3, r3, i3, a3) => (o2.dynCall_vjfii = Y.qa)(e8, t3, n3, r3, i3, a3), o2.dynCall_vjiii = (e8, t3, n3, r3, i3, a3) => (o2.dynCall_vjiii = Y.ra)(e8, t3, n3, r3, i3, a3), o2.dynCall_vj = (e8, t3, n3) => (o2.dynCall_vj = Y.sa)(e8, t3, n3), o2.dynCall_vjiiiii = (e8, t3, n3, r3, i3, a3, s3, c3) => (o2.dynCall_vjiiiii = Y.ta)(e8, t3, n3, r3, i3, a3, s3, c3), o2.dynCall_vjiffii = (e8, t3, n3, r3, i3, a3, s3, c3) => (o2.dynCall_vjiffii = Y.ua)(e8, t3, n3, r3, i3, a3, s3, c3), o2.dynCall_vjiiii = (e8, t3, n3, r3, i3, a3, s3) => (o2.dynCall_vjiiii = Y.va)(e8, t3, n3, r3, i3, a3, s3), o2.dynCall_viijii = (e8, t3, n3, r3, i3, a3, s3) => (o2.dynCall_viijii = Y.wa)(e8, t3, n3, r3, i3, a3, s3), o2.dynCall_iiiiij = (e8, t3, n3, r3, i3, a3, s3) => (o2.dynCall_iiiiij = Y.xa)(e8, t3, n3, r3, i3, a3, s3), o2.dynCall_iiiiijj = (e8, t3, n3, r3, i3, a3, s3, c3, l3) => (o2.dynCall_iiiiijj = Y.ya)(e8, t3, n3, r3, i3, a3, s3, c3, l3), o2.dynCall_iiiiiijj = (e8, t3, n3, r3, i3, a3, s3, c3, l3, u3) => (o2.dynCall_iiiiiijj = Y.za)(e8, t3, n3, r3, i3, a3, s3, c3, l3, u3);
    function Mt(e8, t3) {
      var n3 = $();
      try {
        return G.get(e8)(t3);
      } catch (e9) {
        if (Q(n3), e9 !== e9 + 0) throw e9;
        Z(1, 0);
      }
    }
    function Nt(e8, t3, n3, r3, i3, a3) {
      var o3 = $();
      try {
        return G.get(e8)(t3, n3, r3, i3, a3);
      } catch (e9) {
        if (Q(o3), e9 !== e9 + 0) throw e9;
        Z(1, 0);
      }
    }
    function Pt(e8, t3) {
    ...
    function Ft(e8, t3, n3, r3) {
      var i3 = $();
      try {
        G.get(e8)(t3, n3, r3);
      } catch (e9) {
        if (Q(i3), e9 !== e9 + 0) throw e9;
        Z(1, 0);
      }
    }
    function It(e8, t3, n3) {
      var r3 = $();
      try {
        return G.get(e8)(t3, n3);
      } catch (e9) {
        if (Q(r3), e9 !== e9 + 0) throw e9;
        Z(1, 0);
      }
    }
    function Lt(e8, t3, n3) {
      var r3 = $();
      try {
        G.get(e8)(t3, n3);
      } catch (e9) {
    ...
    function Rt(e8) {
      ...
      try {
        ...
        if (Q(t3), e9 !== e9 + 0) throw e9;
        Z(1, 0);
      }
    }
    function zt(e8, t3, n3, r3) {
      var i3 = $();
      try {
        return G.get(e8)(t3, n3, r3);
      } catch (e9) {
        if (Q(i3), e9 !== e9 + 0) throw e9;
        Z(1, 0);
      }
    }
    function Bt(e8, t3, n3, r3, i3) {
      var a3 = $();
      try {
        G.get(e8)(t3, n3, r3, i3);
      } catch (e9) {
        if (Q(a3), e9 !== e9 + 0) throw e9;
        Z(1, 0);
      }
    }
    var Vt;
    ...
    function Ht() {
      function e8() {
        if (!Vt && (Vt = true, o2.calledRun = true, !_2)) {
          var e9;
          if (I2(O2), s2(o2), (e9 = o2.onRuntimeInitialized) == null || e9.call(o2), o2.postRun) for (typeof o2.postRun == `function` && (o2.postRun = [o2.postRun]); o2.postRun.length; ) {
            var t3 = o2.postRun.shift();
            k2.unshift(t3);
          }
          I2(k2);
        }
      ...
      if (!(0 < j2)) {
        if (o2.preRun) for (typeof o2.preRun == `function` && (o2.preRun = [o2.preRun]); o2.preRun.length; ) A2();
        I2(D2), 0 < j2 || (o2.setStatus ? (o2.setStatus(`Running...`), setTimeout(() => {
          setTimeout(() => o2.setStatus(``), 1), e8();
        }, 1)) : e8());
      }
    }
    if (o2.preInit) for (typeof o2.preInit == `function` && (o2.preInit = [o2.preInit]); 0 < o2.preInit.length; ) o2.preInit.pop()();
    return Ht(), n2 = l2, n2;
  });
})();
var _ = class e2 {
  constructor() {
    throw Error(`RendererLoader is a static class and cannot be instantiated.`);
  }
  static async _tryLoad(e7) {
    return await g({ locateFile: () => e7 });
  }
  static async _loadWithBackup() {
    return e2._ModulePromise || (e2._ModulePromise = e2._tryLoad(e2._wasmURL).catch(async (t2) => {
      let n2 = `https://unpkg.com/${h}@${m}/dist/dotlottie-player.wasm`;
      console.warn(`Primary WASM load failed from ${e2._wasmURL}. Error: ${t2.message}`), console.warn(`Attempting to load WASM from backup URL: ${n2}`);
      try {
        return await e2._tryLoad(n2);
      } catch (e7) {
        throw console.error(`Primary WASM URL failed: ${t2.message}`), console.error(`Backup WASM URL failed: ${e7.message}`), Error(`WASM loading failed from all sources.`);
      }
    })), e2._ModulePromise;
  }
  static async load() {
    return e2._loadWithBackup();
  }
  static setWasmUrl(t2) {
    t2 !== e2._wasmURL && (e2._wasmURL = t2, e2._ModulePromise = null);
  }
};
s(_, `_ModulePromise`, null), s(_, `_wasmURL`, `https://cdn.jsdelivr.net/npm/${h}@${m}/dist/dotlottie-player.wasm`);
var v = class {
  constructor() {
    s(this, `_eventListeners`, /* @__PURE__ */ new Map());
  }
  addEventListener(e7, t2) {
    let n2 = this._eventListeners.get(e7);
    n2 || (n2 = /* @__PURE__ */ new Set(), this._eventListeners.set(e7, n2)), n2.add(t2);
  }
  removeEventListener(e7, t2) {
    let n2 = this._eventListeners.get(e7);
    n2 && (t2 ? (n2.delete(t2), n2.size === 0 && this._eventListeners.delete(e7)) : this._eventListeners.delete(e7));
  }
  dispatch(e7) {
    var _a;
    (_a = this._eventListeners.get(e7.type)) == null ? void 0 : _a.forEach((t2) => t2(e7));
  }
...
var y = class e3 {
  static _initializeObserver() {
    e3._observer || (e3._observer = new IntersectionObserver((t2) => {
      t2.forEach((t3) => {
  ...
  static observe(t2, n2) {
    var _a;
    e3._initializeObserver(), !e3._observedCanvases.has(t2) && (e3._observedCanvases.set(t2, n2), (_a = e3._observer) == null ? void 0 : _a.observe(t2));
  }
  static unobserve(t2) {
    var _a, _b;
    (_a = e3._observer) == null ? void 0 : _a.unobserve(t2), e3._observedCanvases.delete(t2), e3._observedCanvases.size === 0 && ((_b = e3._observer) == null ? void 0 : _b.disconnect(), e3._observer = null);
  }
};
s(y, `_observer`, null), s(y, `_observedCanvases`, /* @__PURE__ */ new Map());
var b = class e4 {
  static _initializeObserver() {
    e4._observer || (e4._observer = new ResizeObserver((t2) => {
      t2.forEach((t3) => {
        let n2 = e4._observedCanvases.get(t3.target);
        if (!n2) return;
        let [r2, i2] = n2;
        clearTimeout(i2);
        let a2 = setTimeout(() => {
        ...
        e4._observedCanvases.set(t3.target, [r2, a2]);
      });
    }));
  }
  static observe(t2, n2) {
    var _a;
    e4._initializeObserver(), !e4._observedCanvases.has(t2) && (e4._observedCanvases.set(t2, [n2, 0]), (_a = e4._observer) == null ? void 0 : _a.observe(t2));
  }
  static unobserve(t2) {
    var _a;
    let n2 = e4._observedCanvases.get(t2);
    if (n2) {
      let e7 = n2[1];
      e7 && clearTimeout(e7);
    }
    (_a = e4._observer) == null ? void 0 : _a.unobserve(t2), e4._observedCanvases.delete(t2), !e4._observedCanvases.size && e4._observer && (e4._observer.disconnect(), e4._observer = null);
  }
};
s(b, `_observer`, null), s(b, `_observedCanvases`, /* @__PURE__ */ new Map());
function x(e7) {
  return /^#([\da-f]{6}|[\da-f]{8})$/iu.test(e7);
}
function S(e7) {
  if (!x(e7)) return 0;
  let t2 = e7.replace(`#`, ``);
...
function C(e7) {
  if (e7.byteLength < 4) return false;
  let t2 = new Uint8Array(e7.slice(0, f.byteLength));
  for (let e8 = 0; e8 < f.length; e8 += 1) if (f[e8] !== t2[e8]) return false;
  return true;
}
function w(e7) {
  return p.every((t2) => Object.hasOwn(e7, t2));
}
function ee(e7) {
  if (typeof e7 == `string`) try {
    return w(JSON.parse(e7));
  } catch {
    return false;
  }
  else return w(e7);
...
function E(e7) {
  let t2 = e7.getBoundingClientRect(), n2 = window.innerHeight || document.documentElement.clientHeight, r2 = window.innerWidth || document.documentElement.clientWidth;
...
function D(e7) {
  ...
  if (t2 instanceof HTMLCanvasElement) {
    ...
    let r2 = t2.width / n2.width, i2 = t2.height / n2.height, a2 = (e7.clientX - n2.left) * r2, o2 = (e7.clientY - n2.top) * i2;
    return !Number.isFinite(a2) || !Number.isFinite(o2) || Number.isNaN(a2) || Number.isNaN(o2) ? null : { x: a2, y: o2 };
  }
  return null;
}
function O(e7) {
  let t2 = e7.replace(`OpenUrl: `, ``), n2 = t2.indexOf(` | Target: `), r2, i2;
  n2 === -1 ? (r2 = t2, i2 = `_blank`) : (r2 = t2.substring(0, n2), i2 = t2.substring(n2 + 11)), window.open(r2, i2);
}
var k = (e7, t2) => {
  let n2 = new e7.VectorChar(), r2 = new Uint8Array(t2);
  for (let e8 = 0; e8 < r2.length; e8 += 1) {
    let t3 = r2[e8];
    t3 !== void 0 && typeof t3 == `number` && n2.push_back(t3);
  }
  return n2;
};
var A = (e7, t2) => e7 === `reverse` ? t2.Mode.Reverse : e7 === `bounce` ? t2.Mode.Bounce : e7 === `reverse-bounce` ? t2.Mode.ReverseBounce : t2.Mode.Forward;
var j = (e7, t2) => e7 === `contain` ? t2.Fit.Contain : e7 === `cover` ? t2.Fit.Cover : e7 === `fill` ? t2.Fit.Fill : e7 === `fit-height` ? t2.Fit.FitHeight : e7 === `fit-width` ? t2.Fit.FitWidth : t2.Fit.None;
var M = (e7, t2) => {
  let n2 = new t2.VectorFloat();
  return n2.push_back(e7[0]), n2.push_back(e7[1]), n2;
};
var N = (e7, t2) => {
  let n2 = new t2.VectorFloat();
  return e7.length === 2 ? (n2.push_back(e7[0]), n2.push_back(e7[1]), n2) : n2;
};
var P = (e7, t2) => e7 ? { align: M(e7.align ?? [0.5, 0.5], t2), fit: j(e7.fit ?? `contain`, t2) } : t2.createDefaultLayout();
var F = class e5 {
  constructor(t2) {
    var _a, _b;
    s(this, `_canvas`, null), s(this, `_pendingLoad`, null), s(this, `_context`, null), s(this, `_eventManager`, void 0), s(this, `_animationFrameId`, null), s(this, `_frameManager`, void 0), s(this, `_dotLottieCore`, null), s(this, `_stateMachineId`, ``), s(this, `_stateMachineConfig`, null), s(this, `_isStateMachineRunning`, false), s(this, `_stateMachineObserverHandle`, null), s(this, `_stateMachineInternalMessageObserver`, null), s(this, `_dotLottieObserverHandle`, null), s(this, `_renderConfig`, {}), s(this, `_isFrozen`, false), s(this, `_backgroundColor`, null), s(this, `_boundOnClick`, null), s(this, `_boundOnPointerUp`, null), s(this, `_boundOnPointerDown`, null), s(this, `_boundOnPointerMove`, null), s(this, `_boundOnPointerEnter`, null), s(this, `_boundOnPointerLeave`, null), s(this, `_bufferMismatchCount`, 0), s(this, `_lastExpectedBufferSize`, 0), this._canvas = t2.canvas ?? null, this._eventManager = new v(), this._frameManager = new u(), this._renderConfig = { ...t2.renderConfig, devicePixelRatio: ((_a = t2.renderConfig) == null ? void 0 : _a.devicePixelRatio) || T(), freezeOnOffscreen: ((_b = t2.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true }, _.load().then((n2) => {
      e5._wasmModule = n2;
      let r2 = new n2.CallbackObserver();
      r2.setOnLoad(() => {
        setTimeout(() => {
        ...
        setTimeout(() => {
          this._eventManager.dispatch({ type: `loop`, loopCount: e7 });
        }, 0);
      }), r2.setOnComplete(() => {
        setTimeout(() => {
        ...
        setTimeout(() => {
          this._eventManager.dispatch({ type: `frame`, currentFrame: e7 });
        }, 0);
      }), r2.setOnRender((e7) => {
        setTimeout(() => {
          this._eventManager.dispatch({ type: `render`, currentFrame: e7 });
        }, 0);
      }), this._dotLottieCore = new n2.DotLottiePlayer({ animationId: t2.animationId ?? ``, themeId: t2.themeId ?? ``, stateMachineId: ``, autoplay: t2.autoplay ?? false, backgroundColor: 0, loopAnimation: t2.loop ?? false, loopCount: t2.loopCount ?? 0, mode: A(t2.mode ?? `forward`, n2), segment: N(t2.segment ?? [], n2), speed: t2.speed ?? 1, useFrameInterpolation: t2.useFrameInterpolation ?? true, marker: t2.marker ?? ``, layout: P(t2.layout, n2) }), this._stateMachineId = t2.stateMachineId ?? ``, this._stateMachineConfig = t2.stateMachineConfig ?? null, this._dotLottieObserverHandle = this._dotLottieCore.subscribe(r2), this._eventManager.dispatch({ type: `ready` }), t2.data ? this._canvas ? this._loadFromData(t2.data) : this._pendingLoad = { data: t2.data } : t2.src && (this._canvas ? this._loadFromSrc(t2.src) : this._pendingLoad = { src: t2.src }), t2.backgroundColor && this.setBackgroundColor(t2.backgroundColor);
    }).catch((e7) => {
      this._eventManager.dispatch({ type: `loadError`, error: Error(`Failed to load wasm module: ${e7}`) });
    });
  }
  _dispatchError(e7) {
    console.error(e7), this._eventManager.dispatch({ type: `loadError`, error: Error(e7) });
  }
  async _fetchData(e7) {
    let t2 = await fetch(e7);
    if (!t2.ok) throw Error(`Failed to fetch animation data from URL: ${e7}. ${t2.status}: ${t2.statusText}`);
    let n2 = await t2.arrayBuffer();
    return C(n2) ? n2 : new TextDecoder().decode(n2);
  }
  _loadFromData(t2) {
    if (this._dotLottieCore === null || e5._wasmModule === null) return;
    if (!this._canvas) {
      console.warn(`[dotlottie-web] Cannot load animation without canvas. Call setCanvas() first.`);
      return;
    }
    let n2 = this._canvas.width, r2 = this._canvas.height, i2 = false;
    if (typeof t2 == `string`) {
      if (!ee(t2)) {
        this._dispatchError(`Invalid Lottie JSON string: The provided string does not conform to the Lottie JSON format.`);
        return;
      }
      i2 = this._dotLottieCore.loadAnimationData(t2, n2, r2);
    } else if (t2 instanceof ArrayBuffer) {
      if (!C(t2)) {
        this._dispatchError(`Invalid dotLottie ArrayBuffer: The provided ArrayBuffer does not conform to the dotLottie format.`);
        return;
      }
      i2 = this._dotLottieCore.loadDotLottieData(k(e5._wasmModule, t2), n2, r2);
      ...
      i2 = this._dotLottieCore.loadAnimationData(JSON.stringify(t2), n2, r2);
    } else {
    ...
    i2 && (this._renderConfig.quality !== void 0 && this._dotLottieCore.setQuality(this._renderConfig.quality), d && this.resize(), setTimeout(() => {
      this._eventManager.dispatch({ type: `frame`, currentFrame: this.currentFrame });
    }, 0), this._dotLottieCore.render(), this._draw(), this._stateMachineId ? this.stateMachineLoad(this._stateMachineId) && this.stateMachineStart() && this._startAnimationLoop() : this._dotLottieCore.isPlaying() && this._startAnimationLoop(), d && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.freezeOnOffscreen && (y.observe(this._canvas, this), E(this._canvas) || this.freeze()), this._renderConfig.autoResize && b.observe(this._canvas, this)));
  }
  _loadFromSrc(e7) {
    this._fetchData(e7).then((e8) => this._loadFromData(e8)).catch((t2) => this._dispatchError(`Failed to load animation data from URL: ${e7}. ${t2}`));
  }
  get buffer() {
  ...
  get layout() {
    var _a;
    let t2 = (_a = this._dotLottieCore) == null ? void 0 : _a.config().layout;
    if (t2) return { align: [t2.align.get(0), t2.align.get(1)], fit: (() => {
      var _a2, _b, _c, _d, _e, _f;
      switch (t2.fit) {
        case ((_a2 = e5._wasmModule) == null ? void 0 : _a2.Fit.Contain):
          return `contain`;
        case ((_b = e5._wasmModule) == null ? void 0 : _b.Fit.Cover):
          return `cover`;
        case ((_c = e5._wasmModule) == null ? void 0 : _c.Fit.Fill):
          return `fill`;
        case ((_d = e5._wasmModule) == null ? void 0 : _d.Fit.FitHeight):
          return `fit-height`;
        case ((_e = e5._wasmModule) == null ? void 0 : _e.Fit.FitWidth):
          return `fit-width`;
        case ((_f = e5._wasmModule) == null ? void 0 : _f.Fit.None):
          return `none`;
        default:
          return `contain`;
      }
  ...
  get manifest() {
    var _a;
    try {
      let e7 = (_a = this._dotLottieCore) == null ? void 0 : _a.manifestString();
      if (this._dotLottieCore === null || !e7) return null;
      let t2 = JSON.parse(e7);
  ...
  get segment() {
    var _a;
    let e7 = (_a = this._dotLottieCore) == null ? void 0 : _a.config().segment;
    if (e7 && e7.size() === 2) return [e7.get(0), e7.get(1)];
  }
  get loop() {
    var _a;
  ...
  get mode() {
    var _a, _b, _c, _d;
    let t2 = (_a = this._dotLottieCore) == null ? void 0 : _a.config().mode;
    return t2 === ((_b = e5._wasmModule) == null ? void 0 : _b.Mode.Reverse) ? `reverse` : t2 === ((_c = e5._wasmModule) == null ? void 0 : _c.Mode.Bounce) ? `bounce` : t2 === ((_d = e5._wasmModule) == null ? void 0 : _d.Mode.ReverseBounce) ? `reverse-bounce` : `forward`;
  }
  get isFrozen() {
  ...
  load(t2) {
    this._dotLottieCore === null || e5._wasmModule === null || (this._stopAnimationLoop(), this._cleanupCanvas(), this._isFrozen = false, this._dotLottieCore.setConfig({ animationId: t2.animationId ?? ``, themeId: t2.themeId ?? ``, stateMachineId: ``, autoplay: t2.autoplay ?? false, backgroundColor: 0, loopAnimation: t2.loop ?? false, loopCount: t2.loopCount ?? 0, mode: A(t2.mode ?? `forward`, e5._wasmModule), segment: N(t2.segment ?? [], e5._wasmModule), speed: t2.speed ?? 1, useFrameInterpolation: t2.useFrameInterpolation ?? true, marker: t2.marker ?? ``, layout: P(t2.layout, e5._wasmModule) }), t2.data ? this._canvas ? this._loadFromData(t2.data) : this._pendingLoad = { data: t2.data } : t2.src && (this._canvas ? this._loadFromSrc(t2.src) : this._pendingLoad = { src: t2.src }), this.setBackgroundColor(t2.backgroundColor ?? ``));
  }
  _draw() {
    if (!(this._dotLottieCore === null || this._canvas === null) && (!this._context && `getContext` in this._canvas && typeof this._canvas.getContext == `function` && (typeof HTMLCanvasElement < `u` && this._canvas instanceof HTMLCanvasElement || typeof OffscreenCanvas < `u` && this._canvas instanceof OffscreenCanvas) && (this._context = this._canvas.getContext(`2d`)), this._context)) {
      let e7 = this._dotLottieCore.buffer(), t2 = this._canvas.width * this._canvas.height * 4;
      if (e7.byteLength !== t2) {
        this._lastExpectedBufferSize === t2 ? this._bufferMismatchCount += 1 : (this._bufferMismatchCount = 1, this._lastExpectedBufferSize = t2), this._bufferMismatchCount === 10 && console.warn(`[dotlottie-web] Persistent buffer size mismatch detected. Expected ${t2} bytes for canvas ${this._canvas.width}x${this._canvas.height}, but got ${e7.byteLength} bytes. This may indicate a WASM memory allocation issue or invalid canvas dimensions.`);
        return;
      }
      this._bufferMismatchCount = 0, this._lastExpectedBufferSize = t2;
      let n2 = null, r2 = new Uint8ClampedArray(e7, 0, e7.byteLength);
  ...
  _cleanupCanvas() {
    this._canvas && d && this._canvas instanceof HTMLCanvasElement && (y.unobserve(this._canvas), b.unobserve(this._canvas), this._cleanupStateMachineListeners());
  }
  _initializeCanvas() {
    this._context = null, this._canvas && d && this._canvas instanceof HTMLCanvasElement && this.isLoaded && (this._renderConfig.freezeOnOffscreen && (y.observe(this._canvas, this), E(this._canvas) || this.freeze()), this._renderConfig.autoResize && b.observe(this._canvas, this), this._isStateMachineRunning && this._setupStateMachineListeners()), this._canvas && this._dotLottieCore && this.isLoaded && this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && (this._dotLottieCore.render(), this._draw());
  }
  _stopAnimationLoop() {
  ...
  _animationLoop() {
    ...
    try {
      ...
      console.error(`Error in animation frame:`, e7), this._eventManager.dispatch({ type: `renderError`, error: e7 }), e7 instanceof WebAssembly.RuntimeError && this.destroy();
    }
  }
  play() {
    this._dotLottieCore === null || !this.isLoaded || (this._stopAnimationLoop(), (this._dotLottieCore.play() || this._dotLottieCore.isPlaying()) && (this._isFrozen = false, this._startAnimationLoop()), this._canvas && d && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !E(this._canvas) && this.freeze());
  }
  pause() {
  ...
  stop() {
    ...
    let e7 = this._dotLottieCore.stop();
    this._stopAnimationLoop(), e7 && (this._eventManager.dispatch({ type: `frame`, currentFrame: this.currentFrame }), this._dotLottieCore.render(), this._draw());
  }
  setFrame(e7) {
    this._dotLottieCore !== null && this._dotLottieCore.seek(e7) && this._dotLottieCore.render() && this._draw();
  }
  setSpeed(e7) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), speed: e7 });
  }
  setBackgroundColor(e7) {
    this._dotLottieCore !== null && (d && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = e7 : this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), backgroundColor: S(e7) }), this._backgroundColor = e7);
  }
  setLoop(e7) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), loopAnimation: e7 });
  }
  setLoopCount(e7) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), loopCount: e7 });
  }
  setUseFrameInterpolation(e7) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), useFrameInterpolation: e7 });
  }
  addEventListener(e7, t2) {
    this._eventManager.addEventListener(e7, t2);
  }
  removeEventListener(e7, t2) {
    this._eventManager.removeEventListener(e7, t2);
  }
  destroy() {
    var _a, _b, _c, _d;
    this._stopAnimationLoop(), this._isStateMachineRunning = false, this._cleanupCanvas(), this._stateMachineObserverHandle && ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineUnsubscribe(this._stateMachineObserverHandle), this._stateMachineObserverHandle.delete(), this._stateMachineObserverHandle = null), this._stateMachineInternalMessageObserver && ((_b = this._dotLottieCore) == null ? void 0 : _b.stateMachineInternalUnsubscribe(this._stateMachineInternalMessageObserver), this._stateMachineInternalMessageObserver.delete(), this._stateMachineInternalMessageObserver = null), this._dotLottieObserverHandle && ((_c = this._dotLottieCore) == null ? void 0 : _c.unsubscribe(this._dotLottieObserverHandle), this._dotLottieObserverHandle.delete(), this._dotLottieObserverHandle = null), (_d = this._dotLottieCore) == null ? void 0 : _d.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: `destroy` }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  resize() {
    if (!(!this._dotLottieCore || !this.isLoaded || !this._canvas)) {
      if (d && this._canvas instanceof HTMLCanvasElement) {
        let e7 = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: t2, width: n2 } = this._canvas.getBoundingClientRect();
        t2 !== 0 && n2 !== 0 && (this._canvas.width = n2 * e7, this._canvas.height = t2 * e7);
      }
      this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && (this._dotLottieCore.render(), this._draw());
    }
  }
  setCanvas(e7) {
    if (!(!e7 || this._canvas === e7) && (this._canvas && this._cleanupCanvas(), this._canvas = e7, this._initializeCanvas(), this._pendingLoad)) {
      let e8 = this._pendingLoad;
      this._pendingLoad = null, e8.data ? this._loadFromData(e8.data) : e8.src && this._loadFromSrc(e8.src);
    }
  }
  setTransform(t2) {
    if (!this._dotLottieCore || !e5._wasmModule) return false;
    let n2 = new e5._wasmModule.VectorFloat();
    for (let e7 of t2) n2.push_back(e7);
    let r2 = this._dotLottieCore.setTransform(n2);
    return r2 && this._dotLottieCore.render() && this._draw(), r2;
  }
  getTransform() {
    if (!this._dotLottieCore) return;
    let e7 = [0, 0, 0, 0, 0, 0, 0, 0, 0], t2 = this._dotLottieCore.getTransform();
    for (let n2 = 0; n2 < t2.size(); n2 += 1) e7[n2] = t2.get(n2);
    return e7;
  }
  setSegment(t2, n2) {
    this._dotLottieCore === null || e5._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), segment: N([t2, n2], e5._wasmModule) });
  }
  setMode(t2) {
    this._dotLottieCore === null || e5._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), mode: A(t2, e5._wasmModule) });
  }
  setRenderConfig(e7) {
    let { devicePixelRatio: t2, freezeOnOffscreen: n2, quality: r2, ...i2 } = e7;
    this._renderConfig = { ...this._renderConfig, ...i2, devicePixelRatio: t2 || T(), freezeOnOffscreen: n2 ?? true, ...r2 !== void 0 && { quality: r2 } }, r2 !== void 0 && this._dotLottieCore && this._dotLottieCore.setQuality(r2), d && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? b.observe(this._canvas, this) : b.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? (y.observe(this._canvas, this), E(this._canvas) || this.freeze()) : (y.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(e7) {
    this._dotLottieCore === null || this._dotLottieCore.activeAnimationId() === e7 || !this._canvas || this._dotLottieCore.loadAnimation(e7, this._canvas.width, this._canvas.height) && (this._renderConfig.quality !== void 0 && this._dotLottieCore.setQuality(this._renderConfig.quality), this.resize());
  }
  setMarker(e7) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), marker: e7 });
  }
  markers() {
    var _a;
    let e7 = (_a = this._dotLottieCore) == null ? void 0 : _a.markers();
    if (e7) {
      let t2 = [];
      for (let n2 = 0; n2 < e7.size(); n2 += 1) {
        let r2 = e7.get(n2);
        t2.push({ name: r2.name, time: r2.time, duration: r2.duration });
      }
      return t2;
    }
    return [];
  ...
  setTheme(e7) {
    ...
    let t2 = this._dotLottieCore.setTheme(e7);
    return t2 && (this._dotLottieCore.render(), this._draw()), t2;
  }
  resetTheme() {
    if (this._dotLottieCore === null) return false;
    let e7 = this._dotLottieCore.resetTheme();
    return e7 && (this._dotLottieCore.render(), this._draw()), e7;
  }
  setThemeData(e7) {
    if (this._dotLottieCore === null) return false;
    let t2 = typeof e7 == `string` ? e7 : JSON.stringify(e7), n2 = this._dotLottieCore.setThemeData(t2);
    return n2 && (this._dotLottieCore.render(), this._draw()), n2;
  }
  setSlots(e7) {
    this._dotLottieCore !== null && this._dotLottieCore.setSlots(JSON.stringify(e7)) && (this._dotLottieCore.render(), this._draw());
  }
  _isKeyframeArray(e7) {
    return Array.isArray(e7) && e7.length > 0 && typeof e7[0] == `object` && e7[0] !== null && `t` in e7[0] && `s` in e7[0];
  }
  getSlotIds() {
    if (!this._dotLottieCore) return [];
    let e7 = this._dotLottieCore.getSlotIds(), t2 = [];
    for (let n2 = 0; n2 < e7.size(); n2 += 1) t2.push(e7.get(n2));
    return t2;
  }
  getSlotType(e7) {
    if (!this._dotLottieCore) return;
    let t2 = this._dotLottieCore.getSlotType(e7);
    if (t2) return t2;
  }
  getSlot(e7) {
    if (!this._dotLottieCore) return;
    let t2 = this._dotLottieCore.getSlotStr(e7);
    if (t2) try {
  ...
  setColorSlot(e7, t2) {
    if (this._dotLottieCore === null) return false;
    let n2 = this._isKeyframeArray(t2), r2 = JSON.stringify({ a: n2 ? 1 : 0, k: t2 }), i2 = this._dotLottieCore.setSlotStr(e7, r2);
    return this._dotLottieCore.render(), this._draw(), i2;
  }
  setScalarSlot(e7, t2) {
    if (this._dotLottieCore === null) return false;
    let n2 = typeof t2 != `number`, r2 = JSON.stringify({ a: n2 ? 1 : 0, k: t2 }), i2 = this._dotLottieCore.setSlotStr(e7, r2);
    return this._dotLottieCore.render(), this._draw(), i2;
  }
  setVectorSlot(e7, t2) {
    if (this._dotLottieCore === null) return false;
  ...
  setGradientSlot(e7, t2, n2) {
    if (this._dotLottieCore === null) return false;
    let r2 = this._isKeyframeArray(t2), i2 = JSON.stringify({ k: { a: r2 ? 1 : 0, k: t2 }, p: n2 }), a2 = this._dotLottieCore.setSlotStr(e7, i2);
    return this._dotLottieCore.render(), this._draw(), a2;
  }
  setTextSlot(e7, t2) {
    if (this._dotLottieCore === null) return false;
    let n2 = JSON.parse(this._dotLottieCore.getSlotStr(e7)), r2 = t2;
    if (n2 && `k` in n2 && Array.isArray(n2.k)) {
      let e8 = n2.k[0];
      `s` in e8 && typeof e8.s == `object` && (r2 = { ...e8.s, ...t2 });
    }
    let i2 = JSON.stringify({ a: 0, k: [{ t: 0, s: r2 }] }), a2 = this._dotLottieCore.setSlotStr(e7, i2);
    return this._dotLottieCore.render(), this._draw(), a2;
  }
  resetSlot(e7) {
    if (this._dotLottieCore === null) return false;
    let t2 = this._dotLottieCore.resetSlot(e7);
    return this._dotLottieCore.render(), this._draw(), t2;
  }
  clearSlot(e7) {
    if (this._dotLottieCore === null) return false;
    let t2 = this._dotLottieCore.clearSlot(e7);
    return this._dotLottieCore.render(), this._draw(), t2;
  }
  resetSlots() {
    if (this._dotLottieCore === null) return false;
    let e7 = this._dotLottieCore.resetSlots();
    return this._dotLottieCore.render(), this._draw(), e7;
  }
  clearSlots() {
    if (this._dotLottieCore === null) return false;
    let e7 = this._dotLottieCore.clearSlots();
    return this._dotLottieCore.render(), this._draw(), e7;
  }
  setLayout(t2) {
    this._dotLottieCore === null || e5._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), layout: P(t2, e5._wasmModule) });
  }
  setViewport(e7, t2, n2, r2) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(e7, t2, n2, r2);
  }
  static setWasmUrl(e7) {
    _.setWasmUrl(e7);
  }
  static async registerFont(e7, t2) {
    try {
      let n2 = await _.load(), r2;
      if (typeof t2 == `string`) {
        let e8 = await fetch(t2);
        if (!e8.ok) return console.error(`Failed to fetch font from URL: ${t2}. Status: ${e8.status}`), false;
        r2 = await e8.arrayBuffer();
      } else if (t2 instanceof Uint8Array) {
        let e8 = t2.buffer.slice(t2.byteOffset, t2.byteOffset + t2.byteLength);
        e8 instanceof ArrayBuffer ? r2 = e8 : (r2 = new ArrayBuffer(t2.byteLength), new Uint8Array(r2).set(t2));
      } else r2 = t2;
      let i2 = n2.registerFont(e7, k(n2, r2));
      return i2 || console.error(`Failed to register font "${e7}". Font data may be invalid.`), i2;
    } catch (t3) {
      return console.error(`Error registering font "${e7}":`, t3), false;
    }
  }
  tween(t2, n2) {
    var _a;
    if (!e5._wasmModule) return false;
    let r2 = [0, 0, 1, 1], i2 = new e5._wasmModule.VectorFloat();
    for (let e7 of r2) i2.push_back(e7);
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.tween(t2, n2, i2)) ?? false;
  }
  tweenToMarker(t2, n2) {
    var _a;
    if (!e5._wasmModule) return false;
    let r2 = [0, 0, 1, 1], i2 = new e5._wasmModule.VectorFloat();
    for (let e7 of r2) i2.push_back(e7);
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.tweenToMarker(t2, n2, i2)) ?? false;
  }
  animationSize() {
    var _a, _b;
    return { width: ((_a = this._dotLottieCore) == null ? void 0 : _a.animationSize().get(0)) ?? 0, height: ((_b = this._dotLottieCore) == null ? void 0 : _b.animationSize().get(1)) ?? 0 };
  }
  getLayerBoundingBox(e7) {
    var _a;
    let t2 = (_a = this._dotLottieCore) == null ? void 0 : _a.getLayerBounds(e7);
    if (!t2 || t2.size() !== 8) return;
    let n2 = [];
    for (let e8 = 0; e8 < 8; e8 += 1) n2.push(t2.get(e8));
    return n2;
  }
  static transformThemeToLottieSlots(t2, n2) {
    var _a;
    return ((_a = e5._wasmModule) == null ? void 0 : _a.transformThemeToLottieSlots(t2, n2)) ?? ``;
  }
  _setupStateMachineObservers() {
    if (!this._dotLottieCore || !e5._wasmModule) return;
    let t2 = new e5._wasmModule.CallbackStateMachineObserver();
    t2.setOnStart(() => {
      setTimeout(() => {
    ...
    }), t2.setOnCustomEvent((e7) => {
      this._eventManager.dispatch({ type: `stateMachineCustomEvent`, eventName: e7 });
    }), t2.setOnBooleanInputValueChange((e7, t3, n3) => {
      this._eventManager.dispatch({ type: `stateMachineBooleanInputValueChange`, inputName: e7, newValue: n3, oldValue: t3 });
    }), t2.setOnNumericInputValueChange((e7, t3, n3) => {
      this._eventManager.dispatch({ type: `stateMachineNumericInputValueChange`, inputName: e7, newValue: n3, oldValue: t3 });
    }), t2.setOnStringInputValueChange((e7, t3, n3) => {
      this._eventManager.dispatch({ type: `stateMachineStringInputValueChange`, inputName: e7, newValue: n3, oldValue: t3 });
    }), t2.setOnInputFired((e7) => {
      this._eventManager.dispatch({ type: `stateMachineInputFired`, inputName: e7 });
    }), t2.setOnTransition((e7, t3) => {
      this._eventManager.dispatch({ type: `stateMachineTransition`, fromState: e7, toState: t3 });
    }), t2.setOnStateEntered((e7) => {
      this._eventManager.dispatch({ type: `stateMachineStateEntered`, state: e7 });
    }), t2.setOnStateExit((e7) => {
      this._eventManager.dispatch({ type: `stateMachineStateExit`, state: e7 });
    }), t2.setOnError((e7) => {
      this._eventManager.dispatch({ type: `stateMachineError`, error: e7 });
    });
    let n2 = new e5._wasmModule.CallbackStateMachineInternalObserver();
    n2.setOnMessage((e7) => {
      d ? e7.startsWith(`OpenUrl: `) && O(e7) : this._eventManager.dispatch({ type: `stateMachineInternalMessage`, message: e7 });
    }), this._stateMachineObserverHandle = this._dotLottieCore.stateMachineSubscribe(t2), this._stateMachineInternalMessageObserver = this._dotLottieCore.stateMachineInternalSubscribe(n2);
  }
  ...
  stateMachineLoad(t2) {
    ...
    let n2 = this._dotLottieCore.stateMachineLoad(t2);
    return n2 && this._setupStateMachineObservers(), n2;
  }
  stateMachineLoadData(t2) {
    if (!this._dotLottieCore || !e5._wasmModule) return false;
    this._cleanupStateMachineObservers();
    let n2 = this._dotLottieCore.stateMachineLoadData(t2);
    return n2 && this._setupStateMachineObservers(), n2;
  }
  stateMachineSetConfig(e7) {
    this._stateMachineConfig = e7;
  }
  stateMachineStart() {
    if (e5._wasmModule === null || this._dotLottieCore === null) return false;
    let t2 = e5._wasmModule.createDefaultOpenUrlPolicy();
    if (this._stateMachineConfig) {
      let n3 = this._stateMachineConfig.openUrlPolicy;
      if (n3 && typeof n3.requireUserInteraction == `boolean` && (t2.requireUserInteraction = n3.requireUserInteraction), n3 == null ? void 0 : n3.whitelist) {
        t2.whitelist = new e5._wasmModule.VectorString();
        for (let e7 of n3.whitelist) t2.whitelist.push_back(e7);
      }
    }
    let n2 = this._dotLottieCore.stateMachineStart(t2);
    return n2 && (this._isStateMachineRunning = true, this._setupStateMachineListeners(), this._startAnimationLoop()), n2;
  }
  stateMachineStop() {
    if (!this._dotLottieCore) return false;
    let e7 = this._dotLottieCore.stateMachineStop();
    return e7 && (this._cleanupStateMachineObservers(), this._isStateMachineRunning = false, this._cleanupStateMachineListeners(), this._dotLottieCore.isPlaying() || this._stopAnimationLoop()), e7;
  }
  ...
  stateMachineOverrideState(e7, t2 = false) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineOverrideCurrentState(e7, t2)) ?? false;
  }
  stateMachineGet(e7) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.getStateMachine(e7)) ?? ``;
  }
  stateMachineGetListeners() {
    if (!this._dotLottieCore) return [];
    let e7 = this._dotLottieCore.stateMachineFrameworkSetup(), t2 = [];
    for (let n2 = 0; n2 < e7.size(); n2 += 1) t2.push(e7.get(n2));
    return t2;
  }
  stateMachineSetBooleanInput(e7, t2) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineSetBooleanInput(e7, t2)) ?? false;
  }
  stateMachineSetNumericInput(e7, t2) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineSetNumericInput(e7, t2)) ?? false;
  }
  stateMachineSetStringInput(e7, t2) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineSetStringInput(e7, t2)) ?? false;
  }
  stateMachineGetBooleanInput(e7) {
    var _a;
    return (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineGetBooleanInput(e7);
  }
  stateMachineGetNumericInput(e7) {
    var _a;
    return (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineGetNumericInput(e7);
  }
  stateMachineGetStringInput(e7) {
    var _a;
    return (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineGetStringInput(e7);
  }
  stateMachineGetInputs() {
    if (!this._dotLottieCore) return [];
    let e7 = this._dotLottieCore.stateMachineGetInputs(), t2 = [];
    for (let n2 = 0; n2 < e7.size(); n2 += 1) t2.push(e7.get(n2));
    return t2;
  }
  stateMachineFireEvent(e7) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineFireEvent(e7);
  }
  stateMachinePostClickEvent(e7, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostClickEvent(e7, t2);
  }
  stateMachinePostPointerUpEvent(e7, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerUpEvent(e7, t2);
  }
  stateMachinePostPointerDownEvent(e7, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerDownEvent(e7, t2);
  }
  stateMachinePostPointerMoveEvent(e7, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerMoveEvent(e7, t2);
  }
  stateMachinePostPointerEnterEvent(e7, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerEnterEvent(e7, t2);
  }
  stateMachinePostPointerExitEvent(e7, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerExitEvent(e7, t2);
  }
  _onClick(e7) {
    let t2 = D(e7);
  ...
  _setupStateMachineListeners() {
    if (d && this._canvas instanceof HTMLCanvasElement && this._dotLottieCore !== null && this.isLoaded) {
      let e7 = this.stateMachineGetListeners();
      this._cleanupStateMachineListeners(), e7.includes(`Click`) && (this._boundOnClick = this._onClick.bind(this), this._canvas.addEventListener(`click`, this._boundOnClick)), e7.includes(`PointerUp`) && (this._boundOnPointerUp = this._onPointerUp.bind(this), this._canvas.addEventListener(`pointerup`, this._boundOnPointerUp)), e7.includes(`PointerDown`) && (this._boundOnPointerDown = this._onPointerDown.bind(this), this._canvas.addEventListener(`pointerdown`, this._boundOnPointerDown)), e7.includes(`PointerMove`) && (this._boundOnPointerMove = this._onPointerMove.bind(this), this._canvas.addEventListener(`pointermove`, this._boundOnPointerMove)), e7.includes(`PointerEnter`) && (this._boundOnPointerEnter = this._onPointerEnter.bind(this), this._canvas.addEventListener(`pointerenter`, this._boundOnPointerEnter)), e7.includes(`PointerExit`) && (this._boundOnPointerLeave = this._onPointerLeave.bind(this), this._canvas.addEventListener(`pointerleave`, this._boundOnPointerLeave));
    }
  }
...
var ne = class {
  ...
  getWorker(e7) {
    return this._workers.has(e7) || this._workers.set(e7, new te()), this._workers.get(e7);
  }
  assignAnimationToWorker(e7, t2) {
    this._animationWorkerMap.set(e7, t2);
  }
  unassignAnimationFromWorker(e7) {
    this._animationWorkerMap.delete(e7);
  }
  sendMessage(e7, t2, n2) {
    this.getWorker(e7).postMessage(t2, n2 || []);
  }
  broadcastMessage(e7, t2) {
    this._workers.forEach((n2) => {
      n2.postMessage(e7, t2 || []);
    });
  }
  terminateWorker(e7) {
    let t2 = this._workers.get(e7);
    t2 && (t2.terminate(), this._workers.delete(e7));
  }
};
function re(e7, t2) {
  if (typeof HTMLCanvasElement < `u` && e7 instanceof HTMLCanvasElement) {
    let { height: n2, width: r2 } = e7.getBoundingClientRect();
...
var I = class e6 {
  constructor(t2) {
    var _a, _b;
    if (s(this, `_eventManager`, new v()), s(this, `_id`, void 0), s(this, `_worker`, void 0), s(this, `_canvas`, void 0), s(this, `_dotLottieInstanceState`, { loopCount: 0, markers: [], autoplay: false, backgroundColor: ``, currentFrame: 0, duration: 0, loop: false, mode: `forward`, segment: [0, 0], segmentDuration: 0, speed: 1, totalFrames: 0, isLoaded: false, isPlaying: false, isPaused: false, isStopped: true, isFrozen: false, useFrameInterpolation: false, renderConfig: { devicePixelRatio: T() }, activeAnimationId: ``, activeThemeId: ``, layout: void 0, marker: void 0, isReady: false, manifest: null }), s(this, `_created`, false), s(this, `_boundOnClick`, null), s(this, `_boundOnPointerUp`, null), s(this, `_boundOnPointerDown`, null), s(this, `_boundOnPointerMove`, null), s(this, `_boundOnPointerEnter`, null), s(this, `_boundOnPointerLeave`, null), s(this, `_pendingConfig`, null), t2.canvas) {
      let e7 = typeof HTMLCanvasElement < `u` && t2.canvas instanceof HTMLCanvasElement, n3 = typeof OffscreenCanvas < `u` && t2.canvas instanceof OffscreenCanvas;
      if (!e7 && !n3) throw Error(`Worker-based DotLottie requires HTMLCanvasElement or OffscreenCanvas`);
    }
    this._canvas = t2.canvas ?? null, this._id = `dotlottie-${ie()}`;
    let n2 = t2.workerId || `defaultWorker`;
    this._worker = e6._workerManager.getWorker(n2), e6._workerManager.assignAnimationToWorker(this._id, n2), e6._wasmUrl && this._sendMessage(`setWasmUrl`, { url: e6._wasmUrl });
    let r2 = { ...t2, renderConfig: { ...t2.renderConfig, devicePixelRatio: ((_a = t2.renderConfig) == null ? void 0 : _a.devicePixelRatio) || T(), freezeOnOffscreen: ((_b = t2.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true } };
  ...
  async _create(e7) {
    ...
    let { instanceId: n2 } = await this._sendMessage(`create`, { instanceId: this._id, config: { ...e7, canvas: t2 }, ...re(this._canvas, ((_a = e7.renderConfig) == null ? void 0 : _a.devicePixelRatio) || T()) }, [t2]);
  ...
  async setCanvas(e7) {
    let t2 = typeof HTMLCanvasElement < `u` && e7 instanceof HTMLCanvasElement, n2 = typeof OffscreenCanvas < `u` && e7 instanceof OffscreenCanvas;
    ...
    if (this._canvas !== e7) {
      ...
      this._canvas = e7, !this._created && this._pendingConfig && (await this._create(this._pendingConfig), this._pendingConfig = null);
    }
  }
  get autoplay() {
  ...
  async play() {
    this._created && (await this._sendMessage(`play`, { instanceId: this._id }), await this._updateDotLottieInstanceState(), d && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !E(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async setSpeed(e7) {
    this._created && (await this._sendMessage(`setSpeed`, { instanceId: this._id, speed: e7 }), await this._updateDotLottieInstanceState());
  }
  async setMode(e7) {
    this._created && (await this._sendMessage(`setMode`, { instanceId: this._id, mode: e7 }), await this._updateDotLottieInstanceState());
  }
  async setFrame(e7) {
    this._created && (await this._sendMessage(`setFrame`, { frame: e7, instanceId: this._id }), await this._updateDotLottieInstanceState());
  }
  async setSegment(e7, t2) {
    this._created && (await this._sendMessage(`setSegment`, { instanceId: this._id, segment: [e7, t2] }), await this._updateDotLottieInstanceState());
  }
  async setRenderConfig(e7) {
    if (!this._created) return;
    let { devicePixelRatio: t2, freezeOnOffscreen: n2, quality: r2, ...i2 } = e7;
    await this._sendMessage(`setRenderConfig`, { instanceId: this._id, renderConfig: { ...this._dotLottieInstanceState.renderConfig, ...i2, devicePixelRatio: t2 || T(), freezeOnOffscreen: n2 ?? true, ...r2 !== void 0 && { quality: r2 } } }), await this._updateDotLottieInstanceState(), d && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? b.observe(this._canvas, this) : b.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? (y.observe(this._canvas, this), E(this._canvas) || await this.freeze()) : (y.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && await this.unfreeze()));
  }
  async setUseFrameInterpolation(e7) {
    this._created && (await this._sendMessage(`setUseFrameInterpolation`, { instanceId: this._id, useFrameInterpolation: e7 }), await this._updateDotLottieInstanceState());
  }
  async setTheme(e7) {
    if (!this._created) return false;
    let t2 = this._sendMessage(`setTheme`, { instanceId: this._id, themeId: e7 });
    return await this._updateDotLottieInstanceState(), t2;
  }
  async load(e7) {
    if (!this._created) {
      this._pendingConfig && (this._pendingConfig = { ...this._pendingConfig, ...e7 });
      return;
    }
    await this._sendMessage(`load`, { config: e7, instanceId: this._id }), await this._updateDotLottieInstanceState();
  }
  async setLoop(e7) {
    this._created && (await this._sendMessage(`setLoop`, { instanceId: this._id, loop: e7 }), await this._updateDotLottieInstanceState());
  }
  async setLoopCount(e7) {
    this._created && (await this._sendMessage(`setLoopCount`, { instanceId: this._id, loopCount: e7 }), await this._updateDotLottieInstanceState());
  }
  async resize() {
    if (!this._created || !this._canvas) return;
    let { height: e7, width: t2 } = re(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || T());
    await this._sendMessage(`resize`, { height: e7, instanceId: this._id, width: t2 }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
    this._created && (this._created = false, await this._sendMessage(`destroy`, { instanceId: this._id }), this._cleanupStateMachineListeners(), e6._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), d && this._canvas instanceof HTMLCanvasElement && (y.unobserve(this._canvas), b.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async setBackgroundColor(e7) {
    this._created && (await this._sendMessage(`setBackgroundColor`, { instanceId: this._id, backgroundColor: e7 }), await this._updateDotLottieInstanceState());
  }
  async loadAnimation(e7) {
    this._created && (await this._sendMessage(`loadAnimation`, { animationId: e7, instanceId: this._id }), await this._updateDotLottieInstanceState());
  }
  async setLayout(e7) {
    this._created && (await this._sendMessage(`setLayout`, { instanceId: this._id, layout: e7 }), await this._updateDotLottieInstanceState());
  }
  ...
  async setMarker(e7) {
    this._created && (await this._sendMessage(`setMarker`, { instanceId: this._id, marker: e7 }), await this._updateDotLottieInstanceState());
  }
  async setThemeData(e7) {
    if (!this._created) return false;
    let t2 = await this._sendMessage(`setThemeData`, { instanceId: this._id, themeData: e7 });
    return await this._updateDotLottieInstanceState(), t2;
  }
  async setViewport(e7, t2, n2, r2) {
    return this._created ? this._sendMessage(`setViewport`, { x: e7, y: t2, width: n2, height: r2, instanceId: this._id }) : false;
  }
  async animationSize() {
    return this._created ? this._sendMessage(`animationSize`, { instanceId: this._id }) : { height: 0, width: 0 };
  }
  async tween(e7, t2) {
    return this._created ? this._sendMessage(`tween`, { instanceId: this._id, frame: e7, duration: t2 }) : false;
  }
  async tweenToMarker(e7, t2) {
    return this._created ? this._sendMessage(`tweenToMarker`, { instanceId: this._id, marker: e7, duration: t2 }) : false;
  }
  async setTransform(e7) {
    return this._created ? this._sendMessage(`setTransform`, { instanceId: this._id, transform: e7 }) : false;
  }
  async getTransform() {
    if (this._created) return this._sendMessage(`getTransform`, { instanceId: this._id });
  }
  async _sendMessage(e7, t2, n2) {
    let r2 = { id: `dotlottie-request-${ie()}`, method: e7, params: t2 };
    return this._worker.postMessage(r2, n2 || []), new Promise((t3, n3) => {
      let i2 = (a2) => {
        let o2 = a2.data;
        o2.id === r2.id && (this._worker.removeEventListener(`message`, i2), o2.error ? n3(Error(`Failed to execute method ${e7}: ${o2.error}`)) : t3(o2.result));
      };
  ...
  static async registerFont(t2, n2) {
    try {
      let r2 = ie();
      return e6._workerManager.broadcastMessage({ id: r2, method: `registerFont`, params: { fontName: t2, fontSource: n2 } }), true;
    } catch (e7) {
      return console.error(`Error broadcasting registerFont for "${t2}":`, e7), false;
    }
  }
  async stateMachineLoad(e7) {
    if (!this._created) return false;
    let t2 = await this._sendMessage(`stateMachineLoad`, { instanceId: this._id, stateMachineId: e7 });
    return await this._updateDotLottieInstanceState(), t2;
  }
  async stateMachineLoadData(e7) {
    if (!this._created) return false;
    let t2 = await this._sendMessage(`stateMachineLoadData`, { instanceId: this._id, stateMachineData: e7 });
    return await this._updateDotLottieInstanceState(), t2;
  }
  async stateMachineStart() {
    if (!this._created) return false;
    let e7 = await this._sendMessage(`stateMachineStart`, { instanceId: this._id });
    return e7 && (this._setupStateMachineListeners(), await this._updateDotLottieInstanceState()), e7;
  }
  ...
  async stateMachineSetNumericInput(e7, t2) {
    return this._created ? this._sendMessage(`stateMachineSetNumericInput`, { instanceId: this._id, name: e7, value: t2 }) : false;
  }
  async stateMachineSetBooleanInput(e7, t2) {
    return this._created ? this._sendMessage(`stateMachineSetBooleanInput`, { instanceId: this._id, name: e7, value: t2 }) : false;
  }
  async stateMachineSetConfig(e7) {
    this._created && this._sendMessage(`stateMachineSetConfig`, { instanceId: this._id, config: e7 });
  }
  async stateMachineSetStringInput(e7, t2) {
    return this._created ? this._sendMessage(`stateMachineSetStringInput`, { instanceId: this._id, name: e7, value: t2 }) : false;
  }
  async stateMachineGetNumericInput(e7) {
    if (this._created) return this._sendMessage(`stateMachineGetNumericInput`, { instanceId: this._id, name: e7 });
  }
  async stateMachineGetBooleanInput(e7) {
    if (this._created) return this._sendMessage(`stateMachineGetBooleanInput`, { instanceId: this._id, name: e7 });
  }
  async stateMachineGetStringInput(e7) {
    if (this._created) return this._sendMessage(`stateMachineGetStringInput`, { instanceId: this._id, name: e7 });
  }
  async stateMachineGetInputs() {
    if (this._created) return this._sendMessage(`stateMachineGetInputs`, { instanceId: this._id });
  }
  async stateMachineFireEvent(e7) {
    this._created && this._sendMessage(`stateMachineFireEvent`, { instanceId: this._id, name: e7 });
  }
  ...
  async stateMachineOverrideState(e7, t2 = false) {
    return this._created ? this._sendMessage(`stateMachineOverrideState`, { instanceId: this._id, state: e7, immediate: t2 }) : false;
  }
  async stateMachineGet(e7) {
    return this._created ? this._sendMessage(`stateMachineGet`, { instanceId: this._id, stateMachineId: e7 }) : ``;
  }
  async stateMachineGetListeners() {
    return this._created ? this._sendMessage(`stateMachineGetListeners`, { instanceId: this._id }) : [];
  }
  async stateMachinePostClickEvent(e7, t2) {
    if (this._created) return this._sendMessage(`stateMachinePostClickEvent`, { instanceId: this._id, x: e7, y: t2 });
  }
  async stateMachinePostPointerUpEvent(e7, t2) {
    if (this._created) return this._sendMessage(`stateMachinePostPointerUpEvent`, { instanceId: this._id, x: e7, y: t2 });
  }
  async stateMachinePostPointerDownEvent(e7, t2) {
    if (this._created) return this._sendMessage(`stateMachinePostPointerDownEvent`, { instanceId: this._id, x: e7, y: t2 });
  }
  async stateMachinePostPointerMoveEvent(e7, t2) {
    if (this._created) return this._sendMessage(`stateMachinePostPointerMoveEvent`, { instanceId: this._id, x: e7, y: t2 });
  }
  async stateMachinePostPointerEnterEvent(e7, t2) {
    if (this._created) return this._sendMessage(`stateMachinePostPointerEnterEvent`, { instanceId: this._id, x: e7, y: t2 });
  }
  async stateMachinePostPointerExitEvent(e7, t2) {
    if (this._created) return this._sendMessage(`stateMachinePostPointerExitEvent`, { instanceId: this._id, x: e7, y: t2 });
  }
  _onClick(e7) {
    let t2 = D(e7);
  ...
  async _setupStateMachineListeners() {
    if (d && this._canvas instanceof HTMLCanvasElement && this.isLoaded) {
      let e7 = await this._sendMessage(`stateMachineGetListeners`, { instanceId: this._id });
...
s(I, `_workerManager`, new ne()), s(I, `_wasmUrl`, ``);
var L = ({ animationId: i2, autoplay: a2, backgroundColor: o2, className: s2, createDotLottie: c2, data: l2, dotLottieRefCallback: u2, layout: d2, loop: f2, mode: p2, playOnHover: m2, renderConfig: h2, segment: g2, speed: _2, src: v2, stateMachineConfig: y2, stateMachineId: b2, style: x2, themeData: S2, themeId: C2, useFrameInterpolation: w2, workerId: ee2, ...T2 }) => {
  var _a, _b;
  let E2 = (0, import_react.useRef)(null), D2 = (0, import_react.useRef)(null), O2 = (0, import_react.useRef)(u2), k2 = { speed: _2, mode: p2, loop: f2, useFrameInterpolation: w2, segment: g2, backgroundColor: o2, autoplay: a2, themeId: C2, workerId: ee2, src: v2, data: l2, layout: d2, renderConfig: h2, animationId: i2, stateMachineConfig: y2, stateMachineId: b2 }, A2 = (0, import_react.useRef)(k2);
  O2.current = u2, A2.current = k2;
  let j2 = (0, import_react.useCallback)((e7) => {
    var _a2, _b2;
    D2.current = e7, e7 ? E2.current = c2({ ...A2.current, canvas: e7 }) : ((_a2 = E2.current) == null ? void 0 : _a2.destroy(), E2.current = null), (_b2 = O2.current) == null ? void 0 : _b2.call(O2, E2.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a2, _b2;
    let e7 = (e8) => {
      var _a3, _b3;
      m2 && (e8.type === `mouseenter` && ((_a3 = E2.current) == null ? void 0 : _a3.play()), e8.type === `mouseleave` && ((_b3 = E2.current) == null ? void 0 : _b3.pause()));
    };
    return (_a2 = D2.current) == null ? void 0 : _a2.addEventListener(`mouseenter`, e7), (_b2 = D2.current) == null ? void 0 : _b2.addEventListener(`mouseleave`, e7), () => {
      var _a3, _b3;
      (_a3 = D2.current) == null ? void 0 : _a3.removeEventListener(`mouseenter`, e7), (_b3 = D2.current) == null ? void 0 : _b3.removeEventListener(`mouseleave`, e7);
    };
  }, [m2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.setSpeed(_2 ?? 1);
  }, [_2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.setMode(p2 ?? `forward`);
  }, [p2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.setLoop(f2 ?? false);
  }, [f2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.setUseFrameInterpolation(w2 ?? true);
  }, [w2]), (0, import_react.useEffect)(() => {
    var _a2;
    typeof (g2 == null ? void 0 : g2[0]) == `number` && typeof g2[1] == `number` && ((_a2 = E2.current) == null ? void 0 : _a2.setSegment(g2[0], g2[1]));
  }, [g2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.setBackgroundColor(o2 ?? ``);
  }, [o2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.setRenderConfig(h2 ?? {});
  }, [JSON.stringify(h2)]), (0, import_react.useEffect)(() => {
    var _a2;
    typeof l2 != `string` && typeof l2 != `object` || ((_a2 = E2.current) == null ? void 0 : _a2.load({ data: l2, ...A2.current }));
  }, [l2]), (0, import_react.useEffect)(() => {
    var _a2;
    typeof v2 == `string` && ((_a2 = E2.current) == null ? void 0 : _a2.load({ src: v2, ...A2.current }));
  }, [v2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.setMarker(T2.marker ?? ``);
  }, [T2.marker]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.loadAnimation(i2 ?? ``);
  }, [i2]), (0, import_react.useEffect)(() => {
    var _a2;
    typeof C2 == `string` && ((_a2 = E2.current) == null ? void 0 : _a2.setTheme(C2));
  }, [C2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.setThemeData(S2 ?? ``);
  }, [S2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.setLayout(d2 ?? {});
    ...
    var _a2;
    ((_a2 = E2.current) == null ? void 0 : _a2.isLoaded) && (typeof b2 == `string` && b2 ? E2.current.stateMachineLoad(b2) && E2.current.stateMachineStart() : E2.current.stateMachineStop());
  }, [b2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = E2.current) == null ? void 0 : _a2.stateMachineSetConfig(y2 ?? null);
  }, [y2]), (0, import_jsx_runtime.jsx)(`div`, { className: s2, ...!s2 && { style: { width: `100%`, height: `100%`, lineHeight: 0, ...x2 } }, children: (0, import_jsx_runtime.jsx)(`canvas`, { ref: j2, style: { width: `100%`, height: `100%` }, ...T2 }) });
};
var ae = (e7) => new F(e7);
var R = (e7) => (0, import_jsx_runtime.jsx)(L, { ...e7, createDotLottie: ae });
var oe = (e7) => new I(e7);
var se = (e7) => (0, import_jsx_runtime.jsx)(L, { ...e7, createDotLottie: oe });
var ce = (e7) => {
  I.setWasmUrl(e7), F.setWasmUrl(e7);
};
export {
  R as DotLottieReact,
  se as DotLottieWorkerReact,
  ce as setWasmUrl
};
